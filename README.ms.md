...
<img src="https://raw.githubusercontent.com/wesleysimplicio/ds4-simplicio-apple-v6/main/assets/us4-v6-apple-edition-promo.png" alt="DS4 Simplicio Apple V6 promotional banner" width="100%" />
  ...
  <p>Universal State Runtime pada peranti untuk LLM di Apple Silicon menggunakan MLX, Metal, seni bina berorientasi ANE, C++17/20 dan laluan inferens local-first.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-dev-cli/master/output/imagegen/simplicio-cli-readme-hero-web.png" alt="simplicio-dev-cli verified execution pipeline hero" width="100%" />
  ...
  <p>CLI pelaksanaan yang menukar tugasan perisian satu baris kepada perubahan dipetakan, diff, ujian, bukti validasi dan gelung implementasi boleh disemak.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-mapper/main/assets/llm-project-mapper-hero.png" alt="simplicio-mapper hero" width="100%" />
  ...
  <p>Pemeta projek neutral stack untuk pembangunan agentic: artefak `.simplicio`, konteks projek, struktur starter dan workflow AI coding yang boleh diulang.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-prompt/main/docs/assets/yool-v2-safe-speed-infographic-pt.png" alt="simplicio-prompt yool tuple HAMT infographic" width="100%" />
  ...
  <p>Corak capability-addressing untuk sistem agen: yool, tuple-space, katalog HAMT, guardrails, receipts dan kernel rujukan.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/hermes-turbo-agent/codex/hermes-agent-100x-fast/docs/assets/hermes-turbo-brand/hermes-turbo-agent-vs-openclaw-banner.png" alt="Hermes turbo agent benchmark banner" width="100%" />
  ...
  <p>Branch prestasi Hermes Agent dengan benchmark runtime, perbandingan visual, laluan latensi rendah dan penyelidikan hot-path yang selamat.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-sprint/main/docs/assets/sendsprint-hero.png" alt="simplicio-sprint hero" width="100%" />
  ...
  <p>Workflow penghantaran sprint multi-agen untuk membaca sistem sprint, memeta seni bina repo, menghantar implementasi dan mengesahkan konteks delivery.</p>
</td>
  </tr>
</table>
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/PiAPI-Skills/main/presentation/remotion-tutorial/media/en/preview.gif" alt="PiAPI Skills tutorial preview" width="100%" />
  ...
  <p>Bundle skill untuk Claude, Codex, Hermes, OpenClaw, Cursor, Windsurf dan agen umum meliputi penjanaan media dan workflow LLM.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/WaveSpeedAI-Skills/main/docs/media/tutorial-poster-en.png" alt="WaveSpeedAI Skills tutorial poster" width="100%" />
  ...
  <p>Satu installer dan CLI untuk model WaveSpeedAI dalam host serasi agentskills.io dan persekitaran multi-agen.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-marketing-engine/main/assets/readme/marketing-engine-hero.svg" alt="simplicio-marketing-engine hero" width="100%" />
  ...
  <p>CLI pemasaran AI agnostik penyedia: brief, script, creative, caption, compliance, publish, metrics, ads dan routing model berasaskan environment.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/x-virality-skills/main/skills/x-virality/assets/x-virality-hero.png" alt="x-virality-skills hero" width="100%" />
  ...
  <p>Repo skill standalone untuk mengoptimumkan post X dengan rujukan algoritma For You berasaskan sumber, alat dan ujian.</p>
</td>
  </tr>
</table>
...
## `open_source_dan_penyelidikan_runtime`
...
<td width="50%" valign="top">
  ...
  <p>Edisi Windows untuk runtime inferens tempatan merentas NVIDIA, AMD, Intel, NPU, CUDA, DirectML, Vulkan, AVX dan Windows ML.</p>
</td>
<td width="50%" valign="top">
  <h3><a href="https://github.com/wesleysimplicio/x-bookmarks-panel">x-bookmarks-panel</a></h3>
  <p>Panel Flask local-first yang menukar bookmark x.com menjadi queue tindakan untuk triage dan pelaksanaan dibantu AI.</p>
  <h3><a href="https://github.com/wesleysimplicio/sistema-sindico">sistema-sindico</a></h3>
  <p>Sistem pengurusan kondominium PHP/MySQL dengan asas API untuk workflow aplikasi mudah alih.</p>
  <h3><a href="https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli">brazil-bank CLI suite</a></h3>
  <p>Eksperimen CLI Open Finance dan perbankan Brazil merentas BB, BTG, Inter, Matera, PagBank, PicPay dan Open Finance BR.</p>
  <h3><a href="https://github.com/wesleysimplicio?tab=repositories">lebih banyak repositori</a></h3>
  <p>Kerja tambahan merentas C#, PHP, TypeScript, Rust, Python, C++, alat tempatan, prototaip SaaS dan eksperimen infrastruktur AI.</p>
</td>
  </tr>
</table>
...
| Projek | Stack | Fokus |
|---|---|---|
| [simplicio-dev-cli](https://github.com/wesleysimplicio/simplicio-dev-cli) | Python | Gelung implementasi sah untuk tugasan perisian agentic |
| [simplicio-sprint](https://github.com/wesleysimplicio/simplicio-sprint) | Python | Delivery sprint multi-agen dan pengesahan konteks repo |
| [ds4-simplicio-apple-v6](https://github.com/wesleysimplicio/ds4-simplicio-apple-v6) | C++ | Runtime LLM tempatan untuk Apple Silicon |
| [ds4-simplicio-windows-v6](https://github.com/wesleysimplicio/ds4-simplicio-windows-v6) | C++ | Runtime LLM tempatan untuk Windows |
| [simplicio-marketing-engine](https://github.com/wesleysimplicio/simplicio-marketing-engine) | TypeScript | Automasi pemasaran AI agnostik penyedia |
| [sistema-sindico](https://github.com/wesleysimplicio/sistema-sindico) | PHP | Sistem kondominium dan asas API |
| [brazil-bank-open-finance-br-cli](https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli) | Python | Penyelidikan CLI Open Finance BR |
| [brazil-bank-bb-cli](https://github.com/wesleysimplicio/brazil-bank-bb-cli), [btg](https://github.com/wesleysimplicio/brazil-bank-btg-cli), [inter](https://github.com/wesleysimplicio/brazil-bank-inter-cli), [matera](https://github.com/wesleysimplicio/brazil-bank-matera-cli), [pagbank](https://github.com/wesleysimplicio/brazil-bank-pagbank-cli), [picpay](https://github.com/wesleysimplicio/brazil-bank-picpay-cli) | JavaScript | Eksperimen CLI perbankan Brazil |
| [phoenix-x-algorithm](https://github.com/wesleysimplicio/phoenix-x-algorithm) | Python | Penyelidikan algoritma X dan eksperimen tempatan |
| [bookmarks-oss](https://github.com/wesleysimplicio/bookmarks-oss) | OSS workflow | Eksperimen pengetahuan dan triage berasaskan bookmark |
...
- Saya mengambil berat tentang AI yang berfungsi dalam persekitaran operasi sebenar, bukan hanya demo.
- Saya membina sistem yang mengekalkan konteks, memeta repositori, menyelaras agen dan mengautomasi delivery.
- Saya mencari pengiktirafan melalui impak: kerja terbuka, kejuruteraan serius dan peluang dengan syarikat yang mampu menskalakan kerja ini.
- Hala tujunya mudah: gunakan AI untuk mencipta lebih leverage bagi manusia, pasukan dan masa depan perisian.

---

## `penghargaan_mentor`

Terima kasih khas kepada mentor saya [Jesse Daniel Brown, PhD](https://github.com/JesseBrown1980), berasal dari California, USA, dan penulis 100+ artikel saintifik. Perspektif kemanusiaan dan pendidikannya tentang pengaturcaraan, AI dan sains mengukuhkan misi saya: membina sistem AI praktikal yang memajukan keupayaan manusia.
...
### ⭐ ranking bintang projek — 10 repo awam teratas

</div>

| Kedudukan | Projek | Bintang | Forks | Fokus |
|---:|---|---:|---:|---|
...
> Ranking dikemas kini daripada GitHub Public API pada 2026-06-01, mengecualikan forks dan repositori profil. Badge bintang dan fork dikemas kini secara automatik daripada GitHub.
> WakaTime kekal dibuang kerana bergantung pada akaun/keterlihatan data luaran dan boleh dipaparkan kosong atau rosak dalam profil GitHub awam.
> Kiraan clone dan muat turun release memerlukan pengesahan GitHub Traffic API dan tidak boleh dibenamkan terus dalam README awam.
...
### `menukar idea AI kepada sistem yang melaksanakan`
