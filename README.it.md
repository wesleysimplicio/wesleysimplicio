...
```txt
costruttore di sistemi AI | orchestrazione agenti | runtime local-first | automazione pratica
```
...
[English](README.md) · [Português](README.pt-BR.md) · [Español](README.es.md) · [日本語](README.ja.md) · [한국어](README.ko.md) · [简体中文](README.zh-CN.md) · **Italiano** · [Français](README.fr.md) · [Русский](README.ru.md) · [Polski](README.pl.md) · [हिन्दी](README.hi.md) · [العربية](README.ar.md) · [עברית](README.he.md) · [Bahasa Melayu](README.ms.md) · [Bahasa Indonesia](README.id.md)
...
Costruisco sistemi AI, strumenti per agenti, runtime locali e livelli di automazione che trasformano le idee in esecuzione.

Il mio obiettivo è contribuire all’umanità tramite AI pratica: strumenti che aiutano le persone a pensare meglio, costruire più velocemente, automatizzare responsabilmente ed eseguire lavori complessi con più chiarezza. Voglio che questo lavoro sia riconosciuto per il suo impatto, anche da una grande azienda che valorizzi l’ingegneria ambiziosa applicata al progresso umano reale.
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/ds4-simplicio-apple-v6/main/assets/us4-v6-apple-edition-promo.png" alt="DS4 Simplicio Apple V6 promotional banner" width="100%" />
  ...
  <p>Universal State Runtime on-device per LLM su Apple Silicon con MLX, Metal, architettura orientata ad ANE, C++17/20 e percorsi di inferenza local-first.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-dev-cli/master/output/imagegen/simplicio-cli-readme-hero-web.png" alt="simplicio-dev-cli verified execution pipeline hero" width="100%" />
  ...
  <p>CLI di esecuzione che trasforma task software in modifiche mappate, diff, test, prove di validazione e cicli di implementazione revisionabili.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-mapper/main/assets/llm-project-mapper-hero.png" alt="simplicio-mapper hero" width="100%" />
  ...
  <p>Mapper di progetto stack-neutral per sviluppo agentic: artefatti `.simplicio`, contesto di progetto, struttura starter e workflow AI ripetibili.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-prompt/main/docs/assets/yool-v2-safe-speed-infographic-pt.png" alt="simplicio-prompt yool tuple HAMT infographic" width="100%" />
  ...
  <p>Pattern di capability-addressing per sistemi agentici: yool, tuple-space, cataloghi HAMT, guardrail, ricevute e kernel di riferimento.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/hermes-turbo-agent/codex/hermes-agent-100x-fast/docs/assets/hermes-turbo-brand/hermes-turbo-agent-vs-openclaw-banner.png" alt="Hermes turbo agent benchmark banner" width="100%" />
  ...
  <p>Branch performance di Hermes Agent con benchmark runtime, confronti visivi, percorsi a bassa latenza e ricerca sicura sugli hot path.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-sprint/main/docs/assets/sendsprint-hero.png" alt="simplicio-sprint hero" width="100%" />
  ...
  <p>Workflow multi-agente per delivery sprint: legge sistemi sprint, mappa architettura repo, assegna implementazioni e verifica il contesto.</p>
</td>
  </tr>
</table>
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/PiAPI-Skills/main/presentation/remotion-tutorial/media/en/preview.gif" alt="PiAPI Skills tutorial preview" width="100%" />
  ...
  <p>Bundle di skill per Claude, Codex, Hermes, OpenClaw, Cursor, Windsurf e agenti generici per generazione media e workflow LLM.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/WaveSpeedAI-Skills/main/docs/media/tutorial-poster-en.png" alt="WaveSpeedAI Skills tutorial poster" width="100%" />
  ...
  <p>Un installer e una CLI per modelli WaveSpeedAI su host compatibili con agentskills.io e ambienti multi-agente.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-marketing-engine/main/assets/readme/marketing-engine-hero.svg" alt="simplicio-marketing-engine hero" width="100%" />
  ...
  <p>CLI marketing AI provider-agnostic: brief, script, creative, caption, compliance, publish, metrics, ads e routing modello da ambiente.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/x-virality-skills/main/skills/x-virality/assets/x-virality-hero.png" alt="x-virality-skills hero" width="100%" />
  ...
  <p>Repo skill standalone per ottimizzare post X con riferimenti fondati all’algoritmo For You, strumenti e test.</p>
</td>
  </tr>
</table>
...
<td width="50%" valign="top">
  ...
  <p>Edizione Windows del runtime di inferenza locale per NVIDIA, AMD, Intel, NPU, CUDA, DirectML, Vulkan, AVX e Windows ML.</p>
</td>
<td width="50%" valign="top">
  <h3><a href="https://github.com/wesleysimplicio/x-bookmarks-panel">x-bookmarks-panel</a></h3>
  <p>Pannello Flask local-first che trasforma bookmark x.com in una coda azionabile per triage ed esecuzione assistiti da AI.</p>
  <h3><a href="https://github.com/wesleysimplicio/sistema-sindico">sistema-sindico</a></h3>
  <p>Sistema gestionale condominiale PHP/MySQL con basi API per workflow mobile.</p>
  <h3><a href="https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli">brazil-bank CLI suite</a></h3>
  <p>Esperimenti CLI per Open Finance e banche brasiliane: BB, BTG, Inter, Matera, PagBank, PicPay e Open Finance BR.</p>
  <h3><a href="https://github.com/wesleysimplicio?tab=repositories">altri repository</a></h3>
  <p>Altro lavoro in C#, PHP, TypeScript, Rust, Python, C++, strumenti locali, prototipi SaaS ed esperimenti di infrastruttura AI.</p>
</td>
  </tr>
</table>
...
## `repository_pubbliche_recenti`

| Progetto | Stack | Focus |
|---|---|---|
| [simplicio-dev-cli](https://github.com/wesleysimplicio/simplicio-dev-cli) | Python | Loop di implementazione verificata per task software agentic |
| [simplicio-sprint](https://github.com/wesleysimplicio/simplicio-sprint) | Python | Delivery sprint multi-agente e verifica contesto repo |
| [ds4-simplicio-apple-v6](https://github.com/wesleysimplicio/ds4-simplicio-apple-v6) | C++ | Runtime LLM locale per Apple Silicon |
| [ds4-simplicio-windows-v6](https://github.com/wesleysimplicio/ds4-simplicio-windows-v6) | C++ | Runtime LLM locale per Windows |
| [simplicio-marketing-engine](https://github.com/wesleysimplicio/simplicio-marketing-engine) | TypeScript | Automazione marketing AI provider-agnostic |
| [sistema-sindico](https://github.com/wesleysimplicio/sistema-sindico) | PHP | Sistema condominiale e base API |
| [brazil-bank-open-finance-br-cli](https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli) | Python | Ricerca CLI Open Finance BR |
| [brazil-bank-bb-cli](https://github.com/wesleysimplicio/brazil-bank-bb-cli), [btg](https://github.com/wesleysimplicio/brazil-bank-btg-cli), [inter](https://github.com/wesleysimplicio/brazil-bank-inter-cli), [matera](https://github.com/wesleysimplicio/brazil-bank-matera-cli), [pagbank](https://github.com/wesleysimplicio/brazil-bank-pagbank-cli), [picpay](https://github.com/wesleysimplicio/brazil-bank-picpay-cli) | JavaScript | Esperimenti CLI per banche brasiliane |
| [phoenix-x-algorithm](https://github.com/wesleysimplicio/phoenix-x-algorithm) | Python | Ricerca algoritmo X e sperimentazione locale |
| [bookmarks-oss](https://github.com/wesleysimplicio/bookmarks-oss) | OSS workflow | Esperimenti di conoscenza e triage guidati da bookmark |
...
- Mi interessa l’AI che funziona in ambienti operativi reali, non solo demo.
- Costruisco sistemi che preservano contesto, mappano repository, coordinano agenti e automatizzano delivery.
- Cerco riconoscimento tramite impatto: lavoro aperto, ingegneria seria e opportunità con aziende capaci di scalarlo.
- La direzione è semplice: usare l’AI per creare più leva per persone, team e futuro del software.

---

## `ringraziamento_al_mentore`

Un ringraziamento speciale al mio mentore [Jesse Daniel Brown, PhD](https://github.com/JesseBrown1980), nativo della California, USA, e autore di oltre 100 articoli scientifici. La sua prospettiva umanitaria ed educativa su programmazione, AI e scienza ha rafforzato la mia missione: costruire sistemi AI pratici che aumentino la capacità umana.
...
### storico stelle dei progetti principali
...
### riepilogo linguaggi e repository
...
> Ranking aggiornato dalla API pubblica GitHub il 2026-06-01, escludendo fork e repository del profilo. I badge di stelle e fork si aggiornano automaticamente da GitHub.
> WakaTime resta rimosso perché dipende da account/dati esterni e può risultare vuoto o rotto in un profilo GitHub pubblico.
> Conteggi clone e download release richiedono autenticazione GitHub Traffic API e non possono essere incorporati direttamente in un README pubblico.
...
### `trasformare idee AI in sistemi che eseguono`
