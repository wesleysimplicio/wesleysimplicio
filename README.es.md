...
```txt
ingeniero de software AI-native | construyo con agentes y reviso cada cambio antes de entregarlo
```
...
[English](README.md) · [Português](README.pt-BR.md) · **Español** · [日本語](README.ja.md) · [한국어](README.ko.md) · [简体中文](README.zh-CN.md) · [Italiano](README.it.md) · [Français](README.fr.md) · [Русский](README.ru.md) · [Polski](README.pl.md) · [हिन्दी](README.hi.md) · [العربية](README.ar.md) · [עברית](README.he.md) · [Bahasa Melayu](README.ms.md) · [Bahasa Indonesia](README.id.md)
...
### Cómo uso IA en proyectos reales

Suelo llevar varios cambios al mismo tiempo. La IA me ayuda a escribir código, pero sigo cada tarea hasta las pruebas, la revisión, la pull request y el merge en `main`.

La IA cambia rápido, así que sigo ajustando mi forma de trabajar. Todos los días pruebo algo nuevo sobre código real y solo lo conservo si hace que el siguiente cambio sea más claro, seguro o rápido.

---

## `misión`

Construyo herramientas de IA que uso en proyectos reales. Me importa que ayuden a entender un repositorio, hacer un cambio, probarlo, revisarlo y llevarlo a producción.
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/ds4-simplicio-apple-v6/main/assets/us4-v6-apple-edition-promo.png" alt="DS4 Simplicio Apple V6 promotional banner" width="100%" />
  ...
  <p>Universal State Runtime en el dispositivo para LLMs en Apple Silicon con MLX, Metal, arquitectura orientada a ANE, C++17/20 y rutas de inferencia local-first.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-dev-cli/master/output/imagegen/simplicio-cli-readme-hero-web.png" alt="simplicio-dev-cli verified execution pipeline hero" width="100%" />
  ...
  <p>CLI de ejecución para convertir tareas de software de una línea en cambios mapeados, diffs, pruebas, evidencia de validación y bucles revisables.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-mapper/main/assets/llm-project-mapper-hero.png" alt="simplicio-mapper hero" width="100%" />
  ...
  <p>Mapeador de proyectos neutral a la stack para desarrollo agentic: artefactos `.simplicio`, contexto del proyecto, estructura inicial y flujos repetibles.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-prompt/main/docs/assets/yool-v2-safe-speed-infographic-pt.png" alt="simplicio-prompt yool tuple HAMT infographic" width="100%" />
  ...
  <p>Patrón de direccionamiento de capacidades para sistemas de agentes: yool, tuple-space, catálogos HAMT, guardrails, recibos y kernels de referencia.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/hermes-turbo-agent/codex/hermes-agent-100x-fast/docs/assets/hermes-turbo-brand/hermes-turbo-agent-vs-openclaw-banner.png" alt="Hermes turbo agent benchmark banner" width="100%" />
  ...
  <p>Rama de rendimiento de Hermes Agent con benchmarks, comparaciones visuales, rutas de baja latencia e investigación segura de hot paths.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-sprint/main/docs/assets/sendsprint-hero.png" alt="simplicio-sprint hero" width="100%" />
  ...
  <p>Flujo multiagente de entrega de sprint para leer sistemas de sprint, mapear arquitectura, despachar implementación y verificar contexto.</p>
</td>
  </tr>
</table>
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/PiAPI-Skills/main/presentation/remotion-tutorial/media/en/preview.gif" alt="PiAPI Skills tutorial preview" width="100%" />
  ...
  <p>Bundle de skills para Claude, Codex, Hermes, OpenClaw, Cursor, Windsurf y agentes genéricos con generación multimedia y flujos LLM.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/WaveSpeedAI-Skills/main/docs/media/tutorial-poster-en.png" alt="WaveSpeedAI Skills tutorial poster" width="100%" />
  ...
  <p>Un instalador y una CLI para modelos WaveSpeedAI en hosts compatibles con agentskills.io y entornos multiagente.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-marketing-engine/main/assets/readme/marketing-engine-hero.svg" alt="simplicio-marketing-engine hero" width="100%" />
  ...
  <p>CLI de marketing con IA independiente del proveedor: brief, guion, creativo, copy, cumplimiento, publicación, métricas, anuncios y ruteo por entorno.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/x-virality-skills/main/skills/x-virality/assets/x-virality-hero.png" alt="x-virality-skills hero" width="100%" />
  ...
  <p>Repositorio de skill standalone para optimizar posts en X con referencias fundamentadas del algoritmo For You, herramientas y pruebas.</p>
</td>
  </tr>
</table>
...
## `open_source_e_investigación_de_runtime`
...
<td width="50%" valign="top">
  ...
  <p>Edición Windows del runtime de inferencia local para NVIDIA, AMD, Intel, NPU, CUDA, DirectML, Vulkan, AVX y Windows ML.</p>
</td>
<td width="50%" valign="top">
  <h3><a href="https://github.com/wesleysimplicio/x-bookmarks-panel">x-bookmarks-panel</a></h3>
  <p>Panel Flask local-first que convierte bookmarks de x.com en una cola accionable para triaje y ejecución asistidos por IA.</p>
  <h3><a href="https://github.com/wesleysimplicio/sistema-sindico">sistema-sindico</a></h3>
  <p>Sistema de gestión de condominios en PHP/MySQL con bases de API para flujos móviles.</p>
  <h3><a href="https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli">brazil-bank CLI suite</a></h3>
  <p>Experimentos CLI de Open Finance y bancos brasileños en BB, BTG, Inter, Matera, PagBank, PicPay y Open Finance BR.</p>
  <h3><a href="https://github.com/wesleysimplicio?tab=repositories">más repositorios</a></h3>
  <p>Trabajo adicional en C#, PHP, TypeScript, Rust, Python, C++, herramientas locales, prototipos SaaS e infraestructura de IA.</p>
</td>
  </tr>
</table>
...
## `repos_publicos_recientes`

| Proyecto | Stack | Foco |
|---|---|---|
| [simplicio-dev-cli](https://github.com/wesleysimplicio/simplicio-dev-cli) | Python | Bucle de implementación verificada para tareas agentic de software |
| [simplicio-sprint](https://github.com/wesleysimplicio/simplicio-sprint) | Python | Entrega multiagente de sprint y verificación de contexto |
...
| [simplicio-marketing-engine](https://github.com/wesleysimplicio/simplicio-marketing-engine) | TypeScript | Automatización de marketing con IA independiente de proveedor |
| [sistema-sindico](https://github.com/wesleysimplicio/sistema-sindico) | PHP | Sistema de condominio y base de API |
| [brazil-bank-open-finance-br-cli](https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli) | Python | Investigación CLI de Open Finance BR |
| [brazil-bank-bb-cli](https://github.com/wesleysimplicio/brazil-bank-bb-cli), [btg](https://github.com/wesleysimplicio/brazil-bank-btg-cli), [inter](https://github.com/wesleysimplicio/brazil-bank-inter-cli), [matera](https://github.com/wesleysimplicio/brazil-bank-matera-cli), [pagbank](https://github.com/wesleysimplicio/brazil-bank-pagbank-cli), [picpay](https://github.com/wesleysimplicio/brazil-bank-picpay-cli) | JavaScript | Experimentos CLI de bancos brasileños |
| [phoenix-x-algorithm](https://github.com/wesleysimplicio/phoenix-x-algorithm) | Python | Investigación del algoritmo de X y experimentación local |
| [bookmarks-oss](https://github.com/wesleysimplicio/bookmarks-oss) | OSS workflow | Experimentos de conocimiento y triaje con bookmarks |
...
- Me importa la IA que funciona en entornos reales, no solo en demos.
- Construyo sistemas que preservan contexto, mapean repositorios, coordinan agentes y automatizan entregas.
- Busco reconocimiento por impacto: trabajo abierto, ingeniería seria y oportunidades con empresas que puedan escalarlo.
- La dirección es simple: usar IA para crear más apalancamiento para personas, equipos y el futuro del software.

---

## `agradecimiento_al_mentor`

Agradecimiento especial a mi mentor [Jesse Daniel Brown, PhD](https://github.com/JesseBrown1980), nativo de California, EE. UU., y autor de más de 100 artículos científicos. Su perspectiva humanitaria y educativa sobre programación, IA y ciencia reforzó mi misión: construir sistemas prácticos de IA que amplíen la capacidad humana.
...
### ⭐ ranking por estrellas — top 10 repositorios públicos

</div>

| Rank | Proyecto | Estrellas | Forks | Foco |
|---:|---|---:|---:|---|
...
### historial de estrellas de proyectos principales
...
### gráfico de actividad de contribución
...
### resumen de lenguajes y repositorios
...
> Ranking actualizado desde la API pública de GitHub el 2026-06-01, excluyendo forks y el repositorio de perfil. Las badges de estrellas y forks se actualizan automáticamente.
> WakaTime sigue eliminado porque depende de cuenta/datos externos y puede renderizarse vacío o roto en un perfil público.
> Los conteos de clones y descargas de releases requieren autenticación en GitHub Traffic API y no pueden incrustarse directamente en un README público.
...
### `convirtiendo ideas de IA en sistemas que ejecutan`
