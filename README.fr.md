...
[English](README.md) · [Português](README.pt-BR.md) · [Español](README.es.md) · [日本語](README.ja.md) · [한국어](README.ko.md) · [简体中文](README.zh-CN.md) · [Italiano](README.it.md) · **Français** · [Русский](README.ru.md) · [Polski](README.pl.md) · [हिन्दी](README.hi.md) · [العربية](README.ar.md) · [עברית](README.he.md) · [Bahasa Melayu](README.ms.md) · [Bahasa Indonesia](README.id.md)
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/ds4-simplicio-apple-v6/main/assets/us4-v6-apple-edition-promo.png" alt="DS4 Simplicio Apple V6 promotional banner" width="100%" />
  ...
  <p>Universal State Runtime on-device pour LLM sur Apple Silicon avec MLX, Metal, architecture orientée ANE, C++17/20 et chemins d’inférence local-first.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-dev-cli/master/output/imagegen/simplicio-cli-readme-hero-web.png" alt="simplicio-dev-cli verified execution pipeline hero" width="100%" />
  ...
  <p>CLI d’exécution transformant des tâches logicielles en changements mappés, diffs, tests, preuves de validation et boucles d’implémentation révisables.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-mapper/main/assets/llm-project-mapper-hero.png" alt="simplicio-mapper hero" width="100%" />
  ...
  <p>Mapper de projet neutre côté stack pour développement agentic : artefacts `.simplicio`, contexte projet, structure starter et workflows AI répétables.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-prompt/main/docs/assets/yool-v2-safe-speed-infographic-pt.png" alt="simplicio-prompt yool tuple HAMT infographic" width="100%" />
  ...
  <p>Pattern d’adressage de capacités pour systèmes d’agents : yool, tuple-space, catalogues HAMT, garde-fous, reçus et kernels de référence.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/hermes-turbo-agent/codex/hermes-agent-100x-fast/docs/assets/hermes-turbo-brand/hermes-turbo-agent-vs-openclaw-banner.png" alt="Hermes turbo agent benchmark banner" width="100%" />
  ...
  <p>Branche performance de Hermes Agent avec benchmarks runtime, comparaisons visuelles, chemins faible latence et recherche sûre sur les hot paths.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-sprint/main/docs/assets/sendsprint-hero.png" alt="simplicio-sprint hero" width="100%" />
  ...
  <p>Workflow multi-agent de livraison sprint : lire les systèmes sprint, mapper l’architecture repo, distribuer l’implémentation et vérifier le contexte.</p>
</td>
  </tr>
</table>
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/PiAPI-Skills/main/presentation/remotion-tutorial/media/en/preview.gif" alt="PiAPI Skills tutorial preview" width="100%" />
  ...
  <p>Bundle de skills pour Claude, Codex, Hermes, OpenClaw, Cursor, Windsurf et agents génériques couvrant génération média et workflows LLM.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/WaveSpeedAI-Skills/main/docs/media/tutorial-poster-en.png" alt="WaveSpeedAI Skills tutorial poster" width="100%" />
  ...
  <p>Un installateur et une CLI pour les modèles WaveSpeedAI dans des hôtes compatibles agentskills.io et environnements multi-agents.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-marketing-engine/main/assets/readme/marketing-engine-hero.svg" alt="simplicio-marketing-engine hero" width="100%" />
  ...
  <p>CLI marketing IA agnostique fournisseur : brief, script, créatif, légende, conformité, publication, métriques, ads et routage modèle par environnement.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/x-virality-skills/main/skills/x-virality/assets/x-virality-hero.png" alt="x-virality-skills hero" width="100%" />
  ...
  <p>Repo skill autonome pour optimiser les posts X avec références sourcées de l’algorithme For You, outils et tests.</p>
</td>
  </tr>
</table>
...
## `open_source_et_recherche_runtime`
...
<td width="50%" valign="top">
  ...
  <p>Édition Windows du runtime d’inférence locale pour NVIDIA, AMD, Intel, NPU, CUDA, DirectML, Vulkan, AVX et Windows ML.</p>
</td>
<td width="50%" valign="top">
  <h3><a href="https://github.com/wesleysimplicio/x-bookmarks-panel">x-bookmarks-panel</a></h3>
  <p>Panneau Flask local-first qui transforme les favoris x.com en file actionnable pour triage et exécution assistés par IA.</p>
  <h3><a href="https://github.com/wesleysimplicio/sistema-sindico">sistema-sindico</a></h3>
  <p>Système de gestion de copropriété PHP/MySQL avec bases API pour workflows mobiles.</p>
  <h3><a href="https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli">brazil-bank CLI suite</a></h3>
  <p>Expériences CLI Open Finance et banques brésiliennes : BB, BTG, Inter, Matera, PagBank, PicPay et Open Finance BR.</p>
  <h3><a href="https://github.com/wesleysimplicio?tab=repositories">plus de dépôts</a></h3>
  <p>Autres travaux en C#, PHP, TypeScript, Rust, Python, C++, outils locaux, prototypes SaaS et expériences d’infrastructure IA.</p>
</td>
  </tr>
</table>
...
## `repos_publics_recents`

| Projet | Stack | Focus |
|---|---|---|
| [simplicio-dev-cli](https://github.com/wesleysimplicio/simplicio-dev-cli) | Python | Boucle d’implémentation vérifiée pour tâches logicielles agentic |
| [simplicio-sprint](https://github.com/wesleysimplicio/simplicio-sprint) | Python | Livraison sprint multi-agent et vérification du contexte repo |
| [ds4-simplicio-apple-v6](https://github.com/wesleysimplicio/ds4-simplicio-apple-v6) | C++ | Runtime LLM local pour Apple Silicon |
| [ds4-simplicio-windows-v6](https://github.com/wesleysimplicio/ds4-simplicio-windows-v6) | C++ | Runtime LLM local pour Windows |
| [simplicio-marketing-engine](https://github.com/wesleysimplicio/simplicio-marketing-engine) | TypeScript | Automatisation marketing IA agnostique fournisseur |
| [sistema-sindico](https://github.com/wesleysimplicio/sistema-sindico) | PHP | Système de copropriété et base API |
| [brazil-bank-open-finance-br-cli](https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli) | Python | Recherche CLI Open Finance BR |
| [brazil-bank-bb-cli](https://github.com/wesleysimplicio/brazil-bank-bb-cli), [btg](https://github.com/wesleysimplicio/brazil-bank-btg-cli), [inter](https://github.com/wesleysimplicio/brazil-bank-inter-cli), [matera](https://github.com/wesleysimplicio/brazil-bank-matera-cli), [pagbank](https://github.com/wesleysimplicio/brazil-bank-pagbank-cli), [picpay](https://github.com/wesleysimplicio/brazil-bank-picpay-cli) | JavaScript | Expériences CLI banques brésiliennes |
| [phoenix-x-algorithm](https://github.com/wesleysimplicio/phoenix-x-algorithm) | Python | Recherche algorithme X et expérimentation locale |
| [bookmarks-oss](https://github.com/wesleysimplicio/bookmarks-oss) | OSS workflow | Expériences de connaissance et triage via favoris |
...
- Je m’intéresse à l’IA qui fonctionne dans de vrais environnements opérationnels, pas seulement aux démos.
- Je construis des systèmes qui préservent le contexte, mappent les dépôts, coordonnent les agents et automatisent la livraison.
- Je cherche une reconnaissance par l’impact : travail ouvert, ingénierie sérieuse et opportunités avec des entreprises capables de le passer à l’échelle.
- La direction est simple : utiliser l’IA pour créer plus de levier pour les personnes, les équipes et l’avenir du logiciel.

---

## `remerciement_mentor`

Merci tout particulièrement à mon mentor [Jesse Daniel Brown, PhD](https://github.com/JesseBrown1980), originaire de Californie, USA, et auteur de plus de 100 articles scientifiques. Sa perspective humanitaire et éducative sur la programmation, l’IA et la science a renforcé ma mission : construire des systèmes IA pratiques qui augmentent les capacités humaines.
...
### ⭐ classement par étoiles — top 10 dépôts publics

</div>

| Rang | Projet | Étoiles | Forks | Focus |
|---:|---|---:|---:|---|
...
### historique des étoiles des projets principaux
...
### graphe d’activité de contribution
...
> Classement mis à jour via l’API publique GitHub le 2026-06-01, hors forks et dépôt de profil. Les badges étoiles et forks se mettent à jour automatiquement depuis GitHub.
> WakaTime reste supprimé car il dépend de la visibilité de compte/données externes et peut s’afficher vide ou cassé sur un profil GitHub public.
> Les compteurs de clones et téléchargements de releases exigent l’authentification GitHub Traffic API et ne peuvent pas être intégrés directement dans un README public.
...
### `transformer les idées IA en systèmes qui exécutent`
