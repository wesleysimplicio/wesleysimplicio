...
```txt
software engineer AI-native | saya mengembangkan perangkat lunak dengan agen dan meninjau setiap perubahan sebelum dirilis
```
...
### Cara saya memakai AI dalam proyek nyata

Saya biasanya mengerjakan beberapa perubahan sekaligus. AI membantu saya menulis kode, tetapi setiap tugas tetap saya ikuti melalui pengujian, review, pull request, hingga merge ke `main`.

AI berubah cepat, jadi saya terus menyesuaikan cara bekerja. Setiap hari saya mencoba sesuatu yang baru pada kode nyata dan hanya mempertahankan hal yang membuat perubahan berikutnya lebih jelas, aman, atau cepat.

---

## `misi`

Saya membangun alat AI yang saya pakai dalam proyek nyata. Bagi saya, alat itu harus membantu memahami repositori, membuat perubahan, menguji dan meninjaunya, lalu membawanya ke production.
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/ds4-simplicio-apple-v6/main/assets/us4-v6-apple-edition-promo.png" alt="DS4 Simplicio Apple V6 promotional banner" width="100%" />
  ...
  <p>Universal State Runtime on-device untuk LLM di Apple Silicon menggunakan MLX, Metal, arsitektur berorientasi ANE, C++17/20, dan jalur inferensi local-first.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-dev-cli/master/output/imagegen/simplicio-cli-readme-hero-web.png" alt="simplicio-dev-cli verified execution pipeline hero" width="100%" />
  ...
  <p>CLI eksekusi yang mengubah tugas software satu baris menjadi perubahan terpetakan, diff, test, bukti validasi, dan loop implementasi yang dapat direview.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-mapper/main/assets/llm-project-mapper-hero.png" alt="simplicio-mapper hero" width="100%" />
  ...
  <p>Mapper proyek netral stack untuk pengembangan agentic: artefak `.simplicio`, konteks proyek, struktur starter, dan workflow AI coding yang dapat diulang.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-prompt/main/docs/assets/yool-v2-safe-speed-infographic-pt.png" alt="simplicio-prompt yool tuple HAMT infographic" width="100%" />
  ...
  <p>Pola capability-addressing untuk sistem agen: yool, tuple-space, katalog HAMT, guardrails, receipts, dan reference kernels.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/hermes-turbo-agent/codex/hermes-agent-100x-fast/docs/assets/hermes-turbo-brand/hermes-turbo-agent-vs-openclaw-banner.png" alt="Hermes turbo agent benchmark banner" width="100%" />
  ...
  <p>Branch performa Hermes Agent dengan benchmark runtime, perbandingan visual, jalur low-latency, dan riset optimasi hot-path yang aman.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-sprint/main/docs/assets/sendsprint-hero.png" alt="simplicio-sprint hero" width="100%" />
  ...
  <p>Workflow delivery sprint multi-agen untuk membaca sistem sprint, memetakan arsitektur repo, mendistribusikan implementasi, dan memverifikasi konteks delivery.</p>
</td>
  </tr>
</table>
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/PiAPI-Skills/main/presentation/remotion-tutorial/media/en/preview.gif" alt="PiAPI Skills tutorial preview" width="100%" />
  ...
  <p>Bundle skill untuk Claude, Codex, Hermes, OpenClaw, Cursor, Windsurf, dan agen umum yang mencakup generasi media dan workflow LLM.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/WaveSpeedAI-Skills/main/docs/media/tutorial-poster-en.png" alt="WaveSpeedAI Skills tutorial poster" width="100%" />
  ...
  <p>Satu installer dan CLI untuk model WaveSpeedAI di host kompatibel agentskills.io dan lingkungan multi-agen.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-marketing-engine/main/assets/readme/marketing-engine-hero.svg" alt="simplicio-marketing-engine hero" width="100%" />
  ...
  <p>CLI marketing AI agnostik provider: brief, script, creative, caption, compliance, publish, metrics, ads, dan routing model berbasis environment.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/x-virality-skills/main/skills/x-virality/assets/x-virality-hero.png" alt="x-virality-skills hero" width="100%" />
  ...
  <p>Repo skill standalone untuk mengoptimalkan posting X dengan referensi algoritma For You berbasis sumber, tooling, dan test.</p>
</td>
  </tr>
</table>
...
<td width="50%" valign="top">
  ...
  <p>Edisi Windows dari runtime inferensi lokal untuk NVIDIA, AMD, Intel, NPU, CUDA, DirectML, Vulkan, AVX, dan Windows ML.</p>
</td>
<td width="50%" valign="top">
  <h3><a href="https://github.com/wesleysimplicio/x-bookmarks-panel">x-bookmarks-panel</a></h3>
  <p>Panel Flask local-first yang mengubah bookmark x.com menjadi antrean aksi untuk triage dan eksekusi berbantuan AI.</p>
  <h3><a href="https://github.com/wesleysimplicio/sistema-sindico">sistema-sindico</a></h3>
  <p>Sistem manajemen kondominium PHP/MySQL dengan fondasi API untuk workflow aplikasi mobile.</p>
  <h3><a href="https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli">brazil-bank CLI suite</a></h3>
  <p>Eksperimen CLI Open Finance dan perbankan Brasil di BB, BTG, Inter, Matera, PagBank, PicPay, dan Open Finance BR.</p>
  <h3><a href="https://github.com/wesleysimplicio?tab=repositories">repositori lainnya</a></h3>
  <p>Karya tambahan di C#, PHP, TypeScript, Rust, Python, C++, alat lokal, prototipe SaaS, dan eksperimen infrastruktur AI.</p>
</td>
  </tr>
</table>
...
| Proyek | Stack | Fokus |
|---|---|---|
| [simplicio-dev-cli](https://github.com/wesleysimplicio/simplicio-dev-cli) | Python | Loop implementasi terverifikasi untuk tugas software agentic |
| [simplicio-sprint](https://github.com/wesleysimplicio/simplicio-sprint) | Python | Delivery sprint multi-agen dan verifikasi konteks repo |
| [ds4-simplicio-apple-v6](https://github.com/wesleysimplicio/ds4-simplicio-apple-v6) | C++ | Runtime LLM lokal untuk Apple Silicon |
| [ds4-simplicio-windows-v6](https://github.com/wesleysimplicio/ds4-simplicio-windows-v6) | C++ | Runtime LLM lokal untuk Windows |
| [simplicio-marketing-engine](https://github.com/wesleysimplicio/simplicio-marketing-engine) | TypeScript | Otomasi marketing AI agnostik provider |
| [sistema-sindico](https://github.com/wesleysimplicio/sistema-sindico) | PHP | Sistem kondominium dan fondasi API |
| [brazil-bank-open-finance-br-cli](https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli) | Python | Riset CLI Open Finance BR |
| [brazil-bank-bb-cli](https://github.com/wesleysimplicio/brazil-bank-bb-cli), [btg](https://github.com/wesleysimplicio/brazil-bank-btg-cli), [inter](https://github.com/wesleysimplicio/brazil-bank-inter-cli), [matera](https://github.com/wesleysimplicio/brazil-bank-matera-cli), [pagbank](https://github.com/wesleysimplicio/brazil-bank-pagbank-cli), [picpay](https://github.com/wesleysimplicio/brazil-bank-picpay-cli) | JavaScript | Eksperimen CLI perbankan Brasil |
| [phoenix-x-algorithm](https://github.com/wesleysimplicio/phoenix-x-algorithm) | Python | Riset algoritma X dan eksperimen lokal |
| [bookmarks-oss](https://github.com/wesleysimplicio/bookmarks-oss) | OSS workflow | Eksperimen knowledge dan triage berbasis bookmark |
...
- Saya peduli pada AI yang bekerja di lingkungan operasi nyata, bukan hanya demo.
- Saya membangun sistem yang menjaga konteks, memetakan repositori, mengoordinasikan agen, dan mengotomasi delivery.
- Saya mencari pengakuan melalui dampak: karya terbuka, engineering serius, dan peluang dengan perusahaan yang mampu menskalakan karya ini.
- Arahnya sederhana: gunakan AI untuk menciptakan leverage lebih besar bagi orang, tim, dan masa depan software.

---

## `penghargaan_mentor`

Terima kasih khusus kepada mentor saya [Jesse Daniel Brown, PhD](https://github.com/JesseBrown1980), berasal dari California, USA, dan penulis 100+ artikel ilmiah. Perspektif kemanusiaan dan pendidikannya tentang pemrograman, AI, dan sains memperkuat misi saya: membangun sistem AI praktis yang memajukan kemampuan manusia.
...
### ⭐ peringkat bintang proyek — 10 repo publik teratas

</div>

| Peringkat | Proyek | Bintang | Forks | Fokus |
|---:|---|---:|---:|---|
...
### ringkasan bahasa dan repositori
...
> Peringkat diperbarui dari GitHub Public API pada 2026-06-01, mengecualikan fork dan repositori profil. Badge bintang dan fork otomatis diperbarui dari GitHub.
> WakaTime tetap dihapus karena bergantung pada akun/visibilitas data eksternal dan dapat tampil kosong atau rusak di profil GitHub publik.
> Jumlah clone dan unduhan release memerlukan autentikasi GitHub Traffic API dan tidak dapat disematkan langsung di README publik.
...
### `mengubah ide AI menjadi sistem yang mengeksekusi`
