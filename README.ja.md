...
```txt
AIネイティブなソフトウェアエンジニア | エージェントと開発し、リリースする前にすべての変更を確認する
```
...
[English](README.md) · [Português](README.pt-BR.md) · [Español](README.es.md) · **日本語** · [한국어](README.ko.md) · [简体中文](README.zh-CN.md) · [Italiano](README.it.md) · [Français](README.fr.md) · [Русский](README.ru.md) · [Polski](README.pl.md) · [हिन्दी](README.hi.md) · [العربية](README.ar.md) · [עברית](README.he.md) · [Bahasa Melayu](README.ms.md) · [Bahasa Indonesia](README.id.md)
...
同時に複数の変更を進めることがよくあります。AIはコードを書く助けになりますが、テスト、レビュー、プルリクエスト、`main` へのマージまで、各タスクを自分で追います。

AIは急速に進化しているので、仕事の進め方も見直し続けています。毎日、実際のコードで新しい方法を試し、次の変更をより分かりやすく、安全に、速くできるものだけを残します。

---

## `ミッション`

実際のプロジェクトで使うAIツールを作っています。リポジトリを理解し、変更し、テストし、レビューし、本番に届けるまで役立つことを大切にしています。
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/ds4-simplicio-apple-v6/main/assets/us4-v6-apple-edition-promo.png" alt="DS4 Simplicio Apple V6 promotional banner" width="100%" />
  ...
  <p>Apple Silicon上のLLM向けオンデバイスUniversal State Runtime。MLX、Metal、ANE志向アーキテクチャ、C++17/20、ローカルファースト推論を利用します。</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-dev-cli/master/output/imagegen/simplicio-cli-readme-hero-web.png" alt="simplicio-dev-cli verified execution pipeline hero" width="100%" />
  ...
  <p>一行のソフトウェアタスクを、マップされた変更、diff、テスト、検証証跡、レビュー可能な実装ループへ変える実行CLI。</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-mapper/main/assets/llm-project-mapper-hero.png" alt="simplicio-mapper hero" width="100%" />
  ...
  <p>エージェント開発向けのスタック非依存プロジェクトマッパー。`.simplicio`成果物、プロジェクト文脈、スターター構造、反復可能なAIコーディングワークフローを提供します。</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-prompt/main/docs/assets/yool-v2-safe-speed-infographic-pt.png" alt="simplicio-prompt yool tuple HAMT infographic" width="100%" />
  ...
  <p>エージェントシステムの能力アドレッシングパターン。yool、tuple-space、HAMTカタログ、ガードレール、receipt、参照kernelを含みます。</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/hermes-turbo-agent/codex/hermes-agent-100x-fast/docs/assets/hermes-turbo-brand/hermes-turbo-agent-vs-openclaw-banner.png" alt="Hermes turbo agent benchmark banner" width="100%" />
  ...
  <p>Hermes Agentの性能ブランチ。ランタイムベンチマーク、視覚比較、低レイテンシ経路、安全なホットパス最適化研究を含みます。</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-sprint/main/docs/assets/sendsprint-hero.png" alt="simplicio-sprint hero" width="100%" />
  ...
  <p>スプリントシステムを読み、リポジトリアーキテクチャをマップし、実装を配布し、納品文脈を検証するマルチエージェントフロー。</p>
</td>
  </tr>
</table>
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/PiAPI-Skills/main/presentation/remotion-tutorial/media/en/preview.gif" alt="PiAPI Skills tutorial preview" width="100%" />
  ...
  <p>Claude、Codex、Hermes、OpenClaw、Cursor、Windsurf、汎用エージェント向けのメディア生成とLLMワークフローのスキル群。</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/WaveSpeedAI-Skills/main/docs/media/tutorial-poster-en.png" alt="WaveSpeedAI Skills tutorial poster" width="100%" />
  ...
  <p>agentskills.io互換ホストとマルチエージェント環境向けのWaveSpeedAIモデル用インストーラー兼CLI。</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-marketing-engine/main/assets/readme/marketing-engine-hero.svg" alt="simplicio-marketing-engine hero" width="100%" />
  ...
  <p>プロバイダー非依存のAIマーケティングCLI。brief、script、creative、caption、compliance、publish、metrics、ads、環境ベースのモデルルーティングを扱います。</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/x-virality-skills/main/skills/x-virality/assets/x-virality-hero.png" alt="x-virality-skills hero" width="100%" />
  ...
  <p>X投稿最適化のための独立スキルリポジトリ。For Youアルゴリズムの出典付き参照、ツール、テストを含みます。</p>
</td>
  </tr>
</table>
...
<td width="50%" valign="top">
  ...
  <p>NVIDIA、AMD、Intel、NPU、CUDA、DirectML、Vulkan、AVX、Windows MLを対象にしたローカル推論ランタイムのWindows版。</p>
</td>
<td width="50%" valign="top">
  <h3><a href="https://github.com/wesleysimplicio/x-bookmarks-panel">x-bookmarks-panel</a></h3>
  <p>x.comのブックマークをAI支援のトリアージと実行キューに変換するローカルファーストFlaskパネル。</p>
  <h3><a href="https://github.com/wesleysimplicio/sistema-sindico">sistema-sindico</a></h3>
  <p>モバイルアプリ向けAPI基盤を備えたPHP/MySQLのマンション管理システム。</p>
  <h3><a href="https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli">brazil-bank CLI suite</a></h3>
  <p>BB、BTG、Inter、Matera、PagBank、PicPay、Open Finance BR向けのブラジル銀行CLI実験。</p>
  <h3><a href="https://github.com/wesleysimplicio?tab=repositories">さらに多くのリポジトリ</a></h3>
  <p>C#、PHP、TypeScript、Rust、Python、C++、ローカルツール、SaaSプロトタイプ、AIインフラ実験にわたる追加の仕事。</p>
</td>
  </tr>
</table>
...
| プロジェクト | スタック | 焦点 |
|---|---|---|
| [simplicio-dev-cli](https://github.com/wesleysimplicio/simplicio-dev-cli) | Python | エージェント型ソフトウェアタスクの検証済み実装ループ |
| [simplicio-sprint](https://github.com/wesleysimplicio/simplicio-sprint) | Python | マルチエージェントのスプリント納品とリポジトリ文脈検証 |
| [ds4-simplicio-apple-v6](https://github.com/wesleysimplicio/ds4-simplicio-apple-v6) | C++ | Apple Silicon向けローカルLLMランタイム |
| [ds4-simplicio-windows-v6](https://github.com/wesleysimplicio/ds4-simplicio-windows-v6) | C++ | Windows向けローカルLLMランタイム |
| [simplicio-marketing-engine](https://github.com/wesleysimplicio/simplicio-marketing-engine) | TypeScript | プロバイダー非依存のAIマーケティング自動化 |
| [sistema-sindico](https://github.com/wesleysimplicio/sistema-sindico) | PHP | マンション管理システムとAPI基盤 |
| [brazil-bank-open-finance-br-cli](https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli) | Python | Open Finance BR CLI研究 |
| [brazil-bank-bb-cli](https://github.com/wesleysimplicio/brazil-bank-bb-cli), [btg](https://github.com/wesleysimplicio/brazil-bank-btg-cli), [inter](https://github.com/wesleysimplicio/brazil-bank-inter-cli), [matera](https://github.com/wesleysimplicio/brazil-bank-matera-cli), [pagbank](https://github.com/wesleysimplicio/brazil-bank-pagbank-cli), [picpay](https://github.com/wesleysimplicio/brazil-bank-picpay-cli) | JavaScript | ブラジル銀行CLI実験 |
| [phoenix-x-algorithm](https://github.com/wesleysimplicio/phoenix-x-algorithm) | Python | Xアルゴリズム研究とローカル実験 |
| [bookmarks-oss](https://github.com/wesleysimplicio/bookmarks-oss) | OSS workflow | ブックマーク駆動の知識とトリアージ実験 |
...
- デモだけでなく、実運用環境で動くAIを重視しています。
- 文脈を保持し、リポジトリをマップし、エージェントを調整し、納品を自動化するシステムを作っています。
- オープンな仕事、真剣なエンジニアリング、それを拡大できる企業との機会を通じて、影響による認知を目指しています。
- 方向性は単純です。AIで人、チーム、ソフトウェアの未来により大きなレバレッジを作ることです。

---

## `メンターへの感謝`

メンターである[Jesse Daniel Brown, PhD](https://github.com/JesseBrown1980)に特別な感謝を捧げます。彼は米国カリフォルニア出身で、100本以上の科学論文の著者です。プログラミング、AI、科学に対する人道的・教育的な視点は、人間の能力を高める実用的なAIシステムを作るという私の使命を強めてくれました。
...
### ⭐ スターランキング — 公開リポジトリ上位10

</div>

| 順位 | プロジェクト | スター | フォーク | 焦点 |
|---:|---|---:|---:|---|
...
> ランキングは2026-06-01にGitHub公開APIから更新し、forkとプロフィールリポジトリを除外しています。スターとforkのバッジはGitHubから自動更新されます。
> WakaTimeは外部アカウント/データ可視性に依存し、公開プロフィールで空または壊れて表示される可能性があるため削除したままです。
> clone数とrelease download数はGitHub Traffic API認証が必要なため、公開READMEへ直接埋め込めません。
