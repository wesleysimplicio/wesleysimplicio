...
```txt
מהנדס תוכנה AI-native | מפתח תוכנה בעזרת סוכנים ובודק כל שינוי לפני השחרור
```
...
### איך אני משתמש ב-AI בפרויקטים אמיתיים

בדרך כלל אני מקדם כמה שינויים במקביל. ה-AI עוזר לי לכתוב קוד, אבל אני עוקב אחרי כל משימה דרך בדיקות, review, pull request ועד המיזוג ל-`main`.

ה-AI משתנה מהר, ולכן אני ממשיך להתאים את הדרך שבה אני עובד. בכל יום אני מנסה משהו חדש על קוד אמיתי ושומר רק את מה שהופך את השינוי הבא לברור, בטוח או מהיר יותר.

---

## `משימה`

אני בונה כלי AI שבהם אני משתמש בפרויקטים אמיתיים. חשוב לי שהם יעזרו להבין repository, לבצע שינוי, לבדוק ולעבור עליו, ואז להעלות אותו ל-production.
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/ds4-simplicio-apple-v6/main/assets/us4-v6-apple-edition-promo.png" alt="DS4 Simplicio Apple V6 promotional banner" width="100%" />
  ...
  <p>Universal State Runtime על המכשיר עבור LLMs ב-Apple Silicon, עם MLX, Metal, ארכיטקטורה מכוונת ANE, C++17/20 ונתיבי inference מקומיים תחילה.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-dev-cli/master/output/imagegen/simplicio-cli-readme-hero-web.png" alt="simplicio-dev-cli verified execution pipeline hero" width="100%" />
  ...
  <p>CLI לביצוע שהופך משימות תוכנה בשורה אחת לשינויים ממופים, diffs, בדיקות, ראיות אימות ולולאות יישום שניתנות לסקירה.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-mapper/main/assets/llm-project-mapper-hero.png" alt="simplicio-mapper hero" width="100%" />
  ...
  <p>ממפה פרויקטים ניטרלי ל-stack עבור פיתוח agentic: ארטיפקטים `.simplicio`, הקשר פרויקט, מבנה starter ו-workflows חוזרים ל-AI coding.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-prompt/main/docs/assets/yool-v2-safe-speed-infographic-pt.png" alt="simplicio-prompt yool tuple HAMT infographic" width="100%" />
  ...
  <p>תבנית capability-addressing למערכות סוכנים: yool, tuple-space, קטלוגי HAMT, guardrails, receipts ו-reference kernels.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/hermes-turbo-agent/codex/hermes-agent-100x-fast/docs/assets/hermes-turbo-brand/hermes-turbo-agent-vs-openclaw-banner.png" alt="Hermes turbo agent benchmark banner" width="100%" />
  ...
  <p>ענף ביצועים של Hermes Agent עם runtime benchmarks, השוואות חזותיות, נתיבי latency נמוך ומחקר בטוח של hot-path optimization.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-sprint/main/docs/assets/sendsprint-hero.png" alt="simplicio-sprint hero" width="100%" />
  ...
  <p>זרימת delivery מרובת סוכנים ל-sprint: קריאת מערכות sprint, מיפוי ארכיטקטורת repo, חלוקת implementation ואימות הקשר delivery.</p>
</td>
  </tr>
</table>
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/PiAPI-Skills/main/presentation/remotion-tutorial/media/en/preview.gif" alt="PiAPI Skills tutorial preview" width="100%" />
  ...
  <p>חבילת skills ל-Claude, Codex, Hermes, OpenClaw, Cursor, Windsurf וסוכנים כלליים עבור יצירת מדיה ו-workflows של LLM.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/WaveSpeedAI-Skills/main/docs/media/tutorial-poster-en.png" alt="WaveSpeedAI Skills tutorial poster" width="100%" />
  ...
  <p>installer ו-CLI אחד למודלי WaveSpeedAI ב-hosts תואמי agentskills.io וסביבות מרובות סוכנים.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-marketing-engine/main/assets/readme/marketing-engine-hero.svg" alt="simplicio-marketing-engine hero" width="100%" />
  ...
  <p>CLI שיווק AI שאינו תלוי ספק: brief, script, creative, caption, compliance, publish, metrics, ads וניתוב מודלים לפי סביבה.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/x-virality-skills/main/skills/x-virality/assets/x-virality-hero.png" alt="x-virality-skills hero" width="100%" />
  ...
  <p>מאגר skill עצמאי לאופטימיזציית פוסטים ב-X עם מקורות לאלגוריתם For You, כלים ובדיקות.</p>
</td>
  </tr>
</table>
...
<td width="50%" valign="top">
  ...
  <p>מהדורת Windows של runtime inference מקומי עבור NVIDIA, AMD, Intel, NPU, CUDA, DirectML, Vulkan, AVX ו-Windows ML.</p>
</td>
<td width="50%" valign="top">
  <h3><a href="https://github.com/wesleysimplicio/x-bookmarks-panel">x-bookmarks-panel</a></h3>
  <p>פאנל Flask מקומי תחילה שהופך bookmarks מ-x.com לתור פעולה ל-triage וביצוע בעזרת AI.</p>
  <h3><a href="https://github.com/wesleysimplicio/sistema-sindico">sistema-sindico</a></h3>
  <p>מערכת ניהול בניין PHP/MySQL עם יסודות API ל-workflows של אפליקציה ניידת.</p>
  <h3><a href="https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli">brazil-bank CLI suite</a></h3>
  <p>ניסויי CLI ל-Open Finance ובנקים ברזילאיים: BB, BTG, Inter, Matera, PagBank, PicPay ו-Open Finance BR.</p>
  <h3><a href="https://github.com/wesleysimplicio?tab=repositories">עוד מאגרים</a></h3>
  <p>עבודה נוספת ב-C#, PHP, TypeScript, Rust, Python, C++, כלים מקומיים, אבות טיפוס SaaS וניסויי תשתית AI.</p>
</td>
  </tr>
</table>
...
## `מאגרים_ציבוריים_אחרונים`

| פרויקט | Stack | מיקוד |
|---|---|---|
| [simplicio-dev-cli](https://github.com/wesleysimplicio/simplicio-dev-cli) | Python | לולאת יישום מאומתת למשימות תוכנה agentic |
| [simplicio-sprint](https://github.com/wesleysimplicio/simplicio-sprint) | Python | Sprint delivery מרובה סוכנים ואימות הקשר repo |
| [ds4-simplicio-apple-v6](https://github.com/wesleysimplicio/ds4-simplicio-apple-v6) | C++ | Runtime LLM מקומי ל-Apple Silicon |
| [ds4-simplicio-windows-v6](https://github.com/wesleysimplicio/ds4-simplicio-windows-v6) | C++ | Runtime LLM מקומי ל-Windows |
| [simplicio-marketing-engine](https://github.com/wesleysimplicio/simplicio-marketing-engine) | TypeScript | אוטומציית שיווק AI שאינה תלויה ספק |
| [sistema-sindico](https://github.com/wesleysimplicio/sistema-sindico) | PHP | מערכת ניהול בניין ויסודות API |
| [brazil-bank-open-finance-br-cli](https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli) | Python | מחקר CLI ל-Open Finance BR |
| [brazil-bank-bb-cli](https://github.com/wesleysimplicio/brazil-bank-bb-cli), [btg](https://github.com/wesleysimplicio/brazil-bank-btg-cli), [inter](https://github.com/wesleysimplicio/brazil-bank-inter-cli), [matera](https://github.com/wesleysimplicio/brazil-bank-matera-cli), [pagbank](https://github.com/wesleysimplicio/brazil-bank-pagbank-cli), [picpay](https://github.com/wesleysimplicio/brazil-bank-picpay-cli) | JavaScript | ניסויי CLI לבנקים ברזילאיים |
| [phoenix-x-algorithm](https://github.com/wesleysimplicio/phoenix-x-algorithm) | Python | מחקר אלגוריתם X וניסויים מקומיים |
| [bookmarks-oss](https://github.com/wesleysimplicio/bookmarks-oss) | OSS workflow | ניסויי ידע ו-triage מונחי bookmarks |
...
- אכפת לי מ-AI שעובד בסביבות תפעול אמיתיות, לא רק בדמואים.
- אני בונה מערכות ששומרות הקשר, ממפות מאגרים, מתאמות סוכנים ומאוטמטות delivery.
- אני מחפש הכרה דרך השפעה: עבודה פתוחה, הנדסה רצינית והזדמנויות עם חברות שיכולות להגדיל את העבודה הזו.
- הכיוון פשוט: להשתמש ב-AI כדי ליצור יותר leverage לאנשים, צוותים ועתיד התוכנה.

---

## `תודה_למנטור`

תודה מיוחדת למנטור שלי [Jesse Daniel Brown, PhD](https://github.com/JesseBrown1980), יליד קליפורניה, ארה״ב, ומחבר של יותר מ-100 מאמרים מדעיים. נקודת המבט ההומניטרית והחינוכית שלו על תכנות, AI ומדע חיזקה את המשימה שלי: לבנות מערכות AI מעשיות שמקדמות יכולת אנושית.
...
### ⭐ דירוג כוכבים — 10 המאגרים הציבוריים המובילים

</div>

| דירוג | פרויקט | כוכבים | Forks | מיקוד |
|---:|---|---:|---:|---|
...
### היסטוריית כוכבים בפרויקטים מובילים
...
> הדירוג עודכן מ-GitHub Public API ב-2026-06-01, ללא forks ומאגר הפרופיל. תגי כוכבים ו-forks מתעדכנים אוטומטית מ-GitHub.
> WakaTime נשאר מוסר כי הוא תלוי בחשבון/נראות נתונים חיצוניים ועלול להופיע ריק או שבור בפרופיל GitHub ציבורי.
> ספירות clones והורדות releases דורשות אימות GitHub Traffic API ולא ניתן להטמיע אותן ישירות ב-README ציבורי.
...
### `הפיכת רעיונות AI למערכות שמבצעות`
