...
```txt
مهندس برمجيات AI-native | أطوّر البرمجيات بمساعدة الوكلاء وأراجع كل تغيير قبل إطلاقه
```
...
### كيف أستخدم الذكاء الاصطناعي في المشاريع الحقيقية

غالبًا ما أعمل على عدة تغييرات في وقت واحد. يساعدني الذكاء الاصطناعي في كتابة الشيفرة، لكنني أتابع كل مهمة عبر الاختبارات والمراجعة وطلب السحب حتى دمجها في `main`.

يتغير الذكاء الاصطناعي بسرعة، لذلك أواصل تعديل طريقتي في العمل. أجرّب كل يوم شيئًا جديدًا على شيفرة حقيقية، ولا أحتفظ إلا بما يجعل التغيير التالي أوضح أو أكثر أمانًا أو أسرع.

---

## `المهمة`

أبني أدوات ذكاء اصطناعي أستخدمها في مشاريع حقيقية. يهمني أن تساعد على فهم المستودع وإجراء التغيير واختباره ومراجعته ثم إطلاقه إلى بيئة الإنتاج.
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/ds4-simplicio-apple-v6/main/assets/us4-v6-apple-edition-promo.png" alt="DS4 Simplicio Apple V6 promotional banner" width="100%" />
  ...
  <p>Universal State Runtime على الجهاز لنماذج LLM على Apple Silicon باستخدام MLX وMetal وبنية موجهة لـ ANE وC++17/20 ومسارات استدلال local-first.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-dev-cli/master/output/imagegen/simplicio-cli-readme-hero-web.png" alt="simplicio-dev-cli verified execution pipeline hero" width="100%" />
  ...
  <p>واجهة CLI تنفيذية تحول مهام البرمجيات ذات السطر الواحد إلى تغييرات مخرطَة وdiffs واختبارات وأدلة تحقق وحلقات تنفيذ قابلة للمراجعة.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-mapper/main/assets/llm-project-mapper-hero.png" alt="simplicio-mapper hero" width="100%" />
  ...
  <p>مخطِّط مشاريع محايد للـ stack للتطوير agentic: ملفات `.simplicio` وسياق المشروع وبنية البداية وتدفقات عمل AI coding قابلة للتكرار.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-prompt/main/docs/assets/yool-v2-safe-speed-infographic-pt.png" alt="simplicio-prompt yool tuple HAMT infographic" width="100%" />
  ...
  <p>نمط capability-addressing لأنظمة الوكلاء: yool وtuple-space وكتالوجات HAMT وguardrails وreceipts وreference kernels.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/hermes-turbo-agent/codex/hermes-agent-100x-fast/docs/assets/hermes-turbo-brand/hermes-turbo-agent-vs-openclaw-banner.png" alt="Hermes turbo agent benchmark banner" width="100%" />
  ...
  <p>فرع أداء Hermes Agent مع runtime benchmarks ومقارنات مرئية ومسارات low-latency وبحث آمن في hot-path optimization.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-sprint/main/docs/assets/sendsprint-hero.png" alt="simplicio-sprint hero" width="100%" />
  ...
  <p>تدفق تسليم sprint متعدد الوكلاء يقرأ أنظمة sprint، ويخرط بنية المستودع، ويوزع التنفيذ، ويتحقق من سياق التسليم.</p>
</td>
  </tr>
</table>
...
## `أدوات_ومهارات_الذكاء_الاصطناعي`
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/PiAPI-Skills/main/presentation/remotion-tutorial/media/en/preview.gif" alt="PiAPI Skills tutorial preview" width="100%" />
  ...
  <p>حزمة skills لـ Claude وCodex وHermes وOpenClaw وCursor وWindsurf والوكلاء العامة لتوليد الوسائط وتدفقات LLM.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/WaveSpeedAI-Skills/main/docs/media/tutorial-poster-en.png" alt="WaveSpeedAI Skills tutorial poster" width="100%" />
  ...
  <p>مثبّت وCLI واحد لنماذج WaveSpeedAI عبر hosts متوافقة مع agentskills.io وبيئات متعددة الوكلاء.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-marketing-engine/main/assets/readme/marketing-engine-hero.svg" alt="simplicio-marketing-engine hero" width="100%" />
  ...
  <p>CLI تسويق بالذكاء الاصطناعي مستقل عن المزوّد: brief وscript وcreative وcaption وcompliance وpublish وmetrics وads وتوجيه النماذج عبر البيئة.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/x-virality-skills/main/skills/x-virality/assets/x-virality-hero.png" alt="x-virality-skills hero" width="100%" />
  ...
  <p>مستودع skill مستقل لتحسين منشورات X بمراجع موثقة لخوارزمية For You وأدوات واختبارات.</p>
</td>
  </tr>
</table>
...
<td width="50%" valign="top">
  ...
  <p>إصدار Windows من runtime الاستدلال المحلي لـ NVIDIA وAMD وIntel وNPU وCUDA وDirectML وVulkan وAVX وWindows ML.</p>
</td>
<td width="50%" valign="top">
  <h3><a href="https://github.com/wesleysimplicio/x-bookmarks-panel">x-bookmarks-panel</a></h3>
  <p>لوحة Flask local-first تحول إشارات x.com إلى queue قابلة للعمل للفرز والتنفيذ بمساعدة AI.</p>
  <h3><a href="https://github.com/wesleysimplicio/sistema-sindico">sistema-sindico</a></h3>
  <p>نظام إدارة مبانٍ سكنية PHP/MySQL مع أساس API لتدفقات تطبيقات الموبايل.</p>
  <h3><a href="https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli">brazil-bank CLI suite</a></h3>
  <p>تجارب CLI لـ Open Finance والبنوك البرازيلية: BB وBTG وInter وMatera وPagBank وPicPay وOpen Finance BR.</p>
  <h3><a href="https://github.com/wesleysimplicio?tab=repositories">مستودعات أكثر</a></h3>
  <p>أعمال إضافية عبر C# وPHP وTypeScript وRust وPython وC++ وأدوات محلية ونماذج SaaS وتجارب بنية تحتية للذكاء الاصطناعي.</p>
</td>
  </tr>
</table>
...
## `المستودعات_العامة_الأخيرة`

| المشروع | التقنية | التركيز |
|---|---|---|
| [simplicio-dev-cli](https://github.com/wesleysimplicio/simplicio-dev-cli) | Python | حلقة تنفيذ متحقَّق منها لمهام برمجية agentic |
| [simplicio-sprint](https://github.com/wesleysimplicio/simplicio-sprint) | Python | تسليم sprint متعدد الوكلاء والتحقق من سياق المستودع |
| [ds4-simplicio-apple-v6](https://github.com/wesleysimplicio/ds4-simplicio-apple-v6) | C++ | Runtime LLM محلي لـ Apple Silicon |
| [ds4-simplicio-windows-v6](https://github.com/wesleysimplicio/ds4-simplicio-windows-v6) | C++ | Runtime LLM محلي لـ Windows |
| [simplicio-marketing-engine](https://github.com/wesleysimplicio/simplicio-marketing-engine) | TypeScript | أتمتة تسويق AI مستقلة عن المزوّد |
| [sistema-sindico](https://github.com/wesleysimplicio/sistema-sindico) | PHP | نظام إدارة مبانٍ وأساس API |
| [brazil-bank-open-finance-br-cli](https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli) | Python | بحث CLI لـ Open Finance BR |
| [brazil-bank-bb-cli](https://github.com/wesleysimplicio/brazil-bank-bb-cli), [btg](https://github.com/wesleysimplicio/brazil-bank-btg-cli), [inter](https://github.com/wesleysimplicio/brazil-bank-inter-cli), [matera](https://github.com/wesleysimplicio/brazil-bank-matera-cli), [pagbank](https://github.com/wesleysimplicio/brazil-bank-pagbank-cli), [picpay](https://github.com/wesleysimplicio/brazil-bank-picpay-cli) | JavaScript | تجارب CLI للبنوك البرازيلية |
| [phoenix-x-algorithm](https://github.com/wesleysimplicio/phoenix-x-algorithm) | Python | بحث خوارزمية X وتجارب محلية |
| [bookmarks-oss](https://github.com/wesleysimplicio/bookmarks-oss) | OSS workflow | تجارب معرفة وفرز مدفوعة بالإشارات |
...
- أهتم بالذكاء الاصطناعي الذي يعمل في بيئات تشغيل حقيقية، وليس في العروض فقط.
- أبني أنظمة تحفظ السياق، وتخرط المستودعات، وتنسق الوكلاء، وتؤتمت التسليم.
- أسعى إلى الاعتراف عبر التأثير: عمل مفتوح، هندسة جادة، وفرص مع شركات قادرة على توسيع هذا العمل.
- الاتجاه بسيط: استخدام AI لخلق قوة مضاعفة أكبر للأشخاص والفرق ومستقبل البرمجيات.

---

## `شكر_المرشد`

شكر خاص لمرشدي [Jesse Daniel Brown, PhD](https://github.com/JesseBrown1980)، من كاليفورنيا في الولايات المتحدة، ومؤلف أكثر من 100 مقالة علمية. نظرته الإنسانية والتعليمية إلى البرمجة والذكاء الاصطناعي والعلم عززت مهمتي: بناء أنظمة AI عملية تقدم القدرة البشرية.
...
### ⭐ ترتيب المشاريع حسب النجوم — أفضل 10 مستودعات عامة

</div>

| الترتيب | المشروع | النجوم | Forks | التركيز |
|---:|---|---:|---:|---|
...
> تم تحديث الترتيب من GitHub Public API في 2026-06-01 مع استبعاد forks ومستودع الملف الشخصي. شارات النجوم وforks تتحدث تلقائياً من GitHub.
> يبقى WakaTime محذوفاً لأنه يعتمد على حساب/بيانات خارجية وقد يظهر فارغاً أو معطلاً في ملف GitHub عام.
> أعداد clones وتنزيلات releases تتطلب مصادقة GitHub Traffic API ولا يمكن تضمينها مباشرة في README عام.
...
### `تحويل أفكار الذكاء الاصطناعي إلى أنظمة تنفّذ`
