...
```txt
AI-native разработчик | работаю с агентами и проверяю каждое изменение перед выпуском
```
...
[English](README.md) · [Português](README.pt-BR.md) · [Español](README.es.md) · [日本語](README.ja.md) · [한국어](README.ko.md) · [简体中文](README.zh-CN.md) · [Italiano](README.it.md) · [Français](README.fr.md) · **Русский** · [Polski](README.pl.md) · [हिन्दी](README.hi.md) · [العربية](README.ar.md) · [עברית](README.he.md) · [Bahasa Melayu](README.ms.md) · [Bahasa Indonesia](README.id.md)
...
### Как я использую AI в реальных проектах

Я часто веду несколько изменений одновременно. AI помогает писать код, но каждую задачу я довожу через тесты, ревью, pull request и слияние в `main`.

AI быстро меняется, поэтому я постоянно корректирую свой подход. Каждый день я пробую что-то новое на реальном коде и оставляю только то, что делает следующее изменение понятнее, безопаснее или быстрее.

---

## `миссия`

Я создаю AI-инструменты, которыми пользуюсь в реальных проектах. Для меня важно, чтобы они помогали понять репозиторий, внести изменение, протестировать и проверить его, а затем выпустить в продакшен.
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/ds4-simplicio-apple-v6/main/assets/us4-v6-apple-edition-promo.png" alt="DS4 Simplicio Apple V6 promotional banner" width="100%" />
  ...
  <p>On-device Universal State Runtime для LLM на Apple Silicon с MLX, Metal, ANE-ориентированной архитектурой, C++17/20 и local-first путями инференса.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-dev-cli/master/output/imagegen/simplicio-cli-readme-hero-web.png" alt="simplicio-dev-cli verified execution pipeline hero" width="100%" />
  ...
  <p>CLI исполнения, превращающий однострочные software-задачи в mapped changes, diff, тесты, доказательства валидации и reviewable implementation loops.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-mapper/main/assets/llm-project-mapper-hero.png" alt="simplicio-mapper hero" width="100%" />
  ...
  <p>Stack-neutral mapper проекта для agentic-разработки: артефакты `.simplicio`, контекст проекта, starter-структура и повторяемые AI coding workflows.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-prompt/main/docs/assets/yool-v2-safe-speed-infographic-pt.png" alt="simplicio-prompt yool tuple HAMT infographic" width="100%" />
  ...
  <p>Паттерн capability-addressing для агентных систем: yool, tuple-space, HAMT-каталоги, guardrails, receipts и reference kernels.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/hermes-turbo-agent/codex/hermes-agent-100x-fast/docs/assets/hermes-turbo-brand/hermes-turbo-agent-vs-openclaw-banner.png" alt="Hermes turbo agent benchmark banner" width="100%" />
  ...
  <p>Performance-ветка Hermes Agent с runtime benchmarks, визуальными сравнениями, low-latency путями и безопасным исследованием hot paths.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-sprint/main/docs/assets/sendsprint-hero.png" alt="simplicio-sprint hero" width="100%" />
  ...
  <p>Мультиагентный sprint delivery workflow: читает sprint-системы, мапит архитектуру repo, распределяет implementation и проверяет delivery context.</p>
</td>
  </tr>
</table>
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/PiAPI-Skills/main/presentation/remotion-tutorial/media/en/preview.gif" alt="PiAPI Skills tutorial preview" width="100%" />
  ...
  <p>Skill bundle для Claude, Codex, Hermes, OpenClaw, Cursor, Windsurf и generic agents, покрывающий media generation и LLM workflows.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/WaveSpeedAI-Skills/main/docs/media/tutorial-poster-en.png" alt="WaveSpeedAI Skills tutorial poster" width="100%" />
  ...
  <p>Один installer и CLI для моделей WaveSpeedAI в agentskills.io-compatible hosts и мультиагентных средах.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-marketing-engine/main/assets/readme/marketing-engine-hero.svg" alt="simplicio-marketing-engine hero" width="100%" />
  ...
  <p>Provider-agnostic AI marketing CLI: brief, script, creative, caption, compliance, publish, metrics, ads и env-driven model routing.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/x-virality-skills/main/skills/x-virality/assets/x-virality-hero.png" alt="x-virality-skills hero" width="100%" />
  ...
  <p>Standalone skill repo для оптимизации постов X с source-grounded ссылками на алгоритм For You, инструментами и тестами.</p>
</td>
  </tr>
</table>
...
## `open_source_и_runtime_исследования`
...
<td width="50%" valign="top">
  ...
  <p>Windows-редакция runtime локального инференса для NVIDIA, AMD, Intel, NPU, CUDA, DirectML, Vulkan, AVX и Windows ML.</p>
</td>
<td width="50%" valign="top">
  <h3><a href="https://github.com/wesleysimplicio/x-bookmarks-panel">x-bookmarks-panel</a></h3>
  <p>Local-first Flask panel, превращающая x.com bookmarks в actionable queue для AI-assisted triage и execution.</p>
  <h3><a href="https://github.com/wesleysimplicio/sistema-sindico">sistema-sindico</a></h3>
  <p>PHP/MySQL система управления кондоминиумом с API-основой для mobile workflows.</p>
  <h3><a href="https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli">brazil-bank CLI suite</a></h3>
  <p>CLI-эксперименты Open Finance и бразильских банков: BB, BTG, Inter, Matera, PagBank, PicPay и Open Finance BR.</p>
  <h3><a href="https://github.com/wesleysimplicio?tab=repositories">другие репозитории</a></h3>
  <p>Дополнительная работа в C#, PHP, TypeScript, Rust, Python, C++, локальных инструментах, SaaS-прототипах и AI infrastructure experiments.</p>
</td>
  </tr>
</table>
...
## `последние_публичные_репозитории`

| Проект | Стек | Фокус |
|---|---|---|
| [simplicio-dev-cli](https://github.com/wesleysimplicio/simplicio-dev-cli) | Python | Проверяемый implementation loop для agentic software tasks |
| [simplicio-sprint](https://github.com/wesleysimplicio/simplicio-sprint) | Python | Мультиагентная sprint-доставка и проверка контекста repo |
| [ds4-simplicio-apple-v6](https://github.com/wesleysimplicio/ds4-simplicio-apple-v6) | C++ | Локальный LLM runtime для Apple Silicon |
| [ds4-simplicio-windows-v6](https://github.com/wesleysimplicio/ds4-simplicio-windows-v6) | C++ | Локальный LLM runtime для Windows |
| [simplicio-marketing-engine](https://github.com/wesleysimplicio/simplicio-marketing-engine) | TypeScript | Provider-agnostic AI marketing automation |
| [sistema-sindico](https://github.com/wesleysimplicio/sistema-sindico) | PHP | Система кондоминиума и API foundation |
| [brazil-bank-open-finance-br-cli](https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli) | Python | Исследование Open Finance BR CLI |
| [brazil-bank-bb-cli](https://github.com/wesleysimplicio/brazil-bank-bb-cli), [btg](https://github.com/wesleysimplicio/brazil-bank-btg-cli), [inter](https://github.com/wesleysimplicio/brazil-bank-inter-cli), [matera](https://github.com/wesleysimplicio/brazil-bank-matera-cli), [pagbank](https://github.com/wesleysimplicio/brazil-bank-pagbank-cli), [picpay](https://github.com/wesleysimplicio/brazil-bank-picpay-cli) | JavaScript | CLI-эксперименты бразильских банков |
| [phoenix-x-algorithm](https://github.com/wesleysimplicio/phoenix-x-algorithm) | Python | Исследование алгоритма X и локальные эксперименты |
| [bookmarks-oss](https://github.com/wesleysimplicio/bookmarks-oss) | OSS workflow | Bookmark-driven knowledge и triage experiments |
...
- Мне важен AI, который работает в реальных операционных средах, а не только в демо.
- Я строю системы, которые сохраняют контекст, мапят репозитории, координируют агентов и автоматизируют доставку.
- Я ищу признание через влияние: open work, серьёзная инженерия и возможности с компаниями, способными масштабировать эту работу.
- Направление простое: использовать AI, чтобы дать больше рычага людям, командам и будущему software.

---

## `благодарность_наставнику`

Особая благодарность моему наставнику [Jesse Daniel Brown, PhD](https://github.com/JesseBrown1980), уроженцу Калифорнии, США, автору более 100 научных статей. Его гуманитарный и образовательный взгляд на программирование, AI и науку укрепил мою миссию: строить практические AI-системы, расширяющие человеческие возможности.
...
### ⭐ рейтинг проектов по звёздам — топ 10 публичных репозиториев

</div>

| Место | Проект | Звёзды | Forks | Фокус |
|---:|---|---:|---:|---|
...
### история звёзд основных проектов
...
> Рейтинг обновлён из публичного GitHub API 2026-06-01, исключая forks и профильный репозиторий. Badges звёзд и forks обновляются автоматически из GitHub.
> WakaTime остаётся удалённым, потому что зависит от внешнего аккаунта/видимости данных и может отображаться пустым или сломанным в публичном GitHub profile.
> Количество clones и release downloads требует аутентификации GitHub Traffic API и не может быть напрямую встроено в публичный README.
...
### `превращаю AI-идеи в исполняемые системы`
