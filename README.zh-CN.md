...
```txt
AI 原生软件工程师 | 与 Agent 一起开发，并在交付前审查每项改动
```
...
[English](README.md) · [Português](README.pt-BR.md) · [Español](README.es.md) · [日本語](README.ja.md) · [한국어](README.ko.md) · **简体中文** · [Italiano](README.it.md) · [Français](README.fr.md) · [Русский](README.ru.md) · [Polski](README.pl.md) · [हिन्दी](README.hi.md) · [العربية](README.ar.md) · [עברית](README.he.md) · [Bahasa Melayu](README.ms.md) · [Bahasa Indonesia](README.id.md)
...
我经常同时推进多项改动。AI 会帮助我写代码，但每项任务仍由我跟进测试、审查、PR 和合并到 `main` 的全过程。

AI 变化很快，所以我也会不断调整工作方式。我每天都在真实代码上尝试新方法，只保留那些能让下一次改动更清晰、更安全或更快的方法。

---

## `使命`

我构建自己会在真实项目中使用的 AI 工具。我关心的是，它们能否帮助我理解仓库、完成改动、测试、审查并发布到生产环境。
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/ds4-simplicio-apple-v6/main/assets/us4-v6-apple-edition-promo.png" alt="DS4 Simplicio Apple V6 promotional banner" width="100%" />
  ...
  <p>面向 Apple Silicon 上 LLM 的设备端 Universal State Runtime，使用 MLX、Metal、ANE 导向架构、C++17/20 和本地优先推理路径。</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-dev-cli/master/output/imagegen/simplicio-cli-readme-hero-web.png" alt="simplicio-dev-cli verified execution pipeline hero" width="100%" />
  ...
  <p>执行 CLI，将一行软件任务转换为映射后的变更、diff、测试、验证证据和可审查的实现循环。</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-mapper/main/assets/llm-project-mapper-hero.png" alt="simplicio-mapper hero" width="100%" />
  ...
  <p>面向 agentic 开发的栈无关项目映射器：共享 `.simplicio` 产物、项目上下文、启动结构和可重复的 AI 编码流程。</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-prompt/main/docs/assets/yool-v2-safe-speed-infographic-pt.png" alt="simplicio-prompt yool tuple HAMT infographic" width="100%" />
  ...
  <p>面向 Agent 系统的能力寻址模式：yool、tuple-space、HAMT 目录、guardrails、receipts 和参考 kernel。</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/hermes-turbo-agent/codex/hermes-agent-100x-fast/docs/assets/hermes-turbo-brand/hermes-turbo-agent-vs-openclaw-banner.png" alt="Hermes turbo agent benchmark banner" width="100%" />
  ...
  <p>Hermes Agent 性能分支，包含运行时基准、可视化对比、低延迟路径和安全 hot-path 优化研究。</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-sprint/main/docs/assets/sendsprint-hero.png" alt="simplicio-sprint hero" width="100%" />
  ...
  <p>多 Agent sprint 交付流程：读取 sprint 系统、映射仓库架构、分派实现并验证交付上下文。</p>
</td>
  </tr>
</table>
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/PiAPI-Skills/main/presentation/remotion-tutorial/media/en/preview.gif" alt="PiAPI Skills tutorial preview" width="100%" />
  ...
  <p>面向 Claude、Codex、Hermes、OpenClaw、Cursor、Windsurf 和通用 Agent 的媒体生成与 LLM 流程技能包。</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/WaveSpeedAI-Skills/main/docs/media/tutorial-poster-en.png" alt="WaveSpeedAI Skills tutorial poster" width="100%" />
  ...
  <p>适用于 agentskills.io 兼容主机和多 Agent 环境的 WaveSpeedAI 模型安装器与 CLI。</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-marketing-engine/main/assets/readme/marketing-engine-hero.svg" alt="simplicio-marketing-engine hero" width="100%" />
  ...
  <p>提供商无关的 AI 营销 CLI：brief、script、creative、caption、compliance、publish、metrics、ads 和环境驱动模型路由。</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/x-virality-skills/main/skills/x-virality/assets/x-virality-hero.png" alt="x-virality-skills hero" width="100%" />
  ...
  <p>独立技能仓库，用带来源依据的 For You 算法参考、工具和测试优化 X 帖子。</p>
</td>
  </tr>
</table>
...
<td width="50%" valign="top">
  ...
  <p>本地推理运行时的 Windows 版本，覆盖 NVIDIA、AMD、Intel、NPU、CUDA、DirectML、Vulkan、AVX 和 Windows ML。</p>
</td>
<td width="50%" valign="top">
  <h3><a href="https://github.com/wesleysimplicio/x-bookmarks-panel">x-bookmarks-panel</a></h3>
  <p>本地优先 Flask 面板，将 x.com 书签变成 AI 辅助分诊和执行队列。</p>
  <h3><a href="https://github.com/wesleysimplicio/sistema-sindico">sistema-sindico</a></h3>
  <p>PHP/MySQL 公寓管理系统，并为移动 App 流程提供 API 基础。</p>
  <h3><a href="https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli">brazil-bank CLI suite</a></h3>
  <p>面向 BB、BTG、Inter、Matera、PagBank、PicPay 和 Open Finance BR 的巴西银行 CLI 实验。</p>
  <h3><a href="https://github.com/wesleysimplicio?tab=repositories">更多仓库</a></h3>
  <p>更多工作覆盖 C#、PHP、TypeScript、Rust、Python、C++、本地工具、SaaS 原型和 AI 基础设施实验。</p>
</td>
  </tr>
</table>
...
| 项目 | 技术栈 | 重点 |
|---|---|---|
| [simplicio-dev-cli](https://github.com/wesleysimplicio/simplicio-dev-cli) | Python | 面向 agentic 软件任务的验证实现循环 |
| [simplicio-sprint](https://github.com/wesleysimplicio/simplicio-sprint) | Python | 多 Agent sprint 交付与仓库上下文验证 |
| [ds4-simplicio-apple-v6](https://github.com/wesleysimplicio/ds4-simplicio-apple-v6) | C++ | Apple Silicon 本地 LLM 运行时 |
| [ds4-simplicio-windows-v6](https://github.com/wesleysimplicio/ds4-simplicio-windows-v6) | C++ | Windows 本地 LLM 运行时 |
| [simplicio-marketing-engine](https://github.com/wesleysimplicio/simplicio-marketing-engine) | TypeScript | 提供商无关的 AI 营销自动化 |
| [sistema-sindico](https://github.com/wesleysimplicio/sistema-sindico) | PHP | 公寓管理系统与 API 基础 |
| [brazil-bank-open-finance-br-cli](https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli) | Python | Open Finance BR CLI 研究 |
| [brazil-bank-bb-cli](https://github.com/wesleysimplicio/brazil-bank-bb-cli), [btg](https://github.com/wesleysimplicio/brazil-bank-btg-cli), [inter](https://github.com/wesleysimplicio/brazil-bank-inter-cli), [matera](https://github.com/wesleysimplicio/brazil-bank-matera-cli), [pagbank](https://github.com/wesleysimplicio/brazil-bank-pagbank-cli), [picpay](https://github.com/wesleysimplicio/brazil-bank-picpay-cli) | JavaScript | 巴西银行 CLI 实验 |
| [phoenix-x-algorithm](https://github.com/wesleysimplicio/phoenix-x-algorithm) | Python | X 算法研究和本地实验 |
| [bookmarks-oss](https://github.com/wesleysimplicio/bookmarks-oss) | OSS workflow | 书签驱动的知识和分诊实验 |
...
- 我关注能在真实运行环境中工作的 AI，而不只是演示。
- 我构建保存上下文、映射仓库、协调 Agent 并自动化交付的系统。
- 我希望通过影响力获得认可：开放工作、严肃工程，以及能够规模化这项工作的公司机会。
- 方向很简单：用 AI 为人、团队和软件的未来创造更大的杠杆。

---

## `导师致谢`

特别感谢我的导师 [Jesse Daniel Brown, PhD](https://github.com/JesseBrown1980)。他来自美国加利福尼亚，发表过 100 多篇科学论文。他对编程、AI 和科学的人道主义与教育视角，强化了我自己的使命：构建提升人类能力的实用 AI 系统。
...
> 排名于 2026-06-01 根据 GitHub 公开 API 更新，排除了 fork 和个人资料仓库。Star 与 fork 徽章会从 GitHub 自动更新。
> WakaTime 继续移除，因为它依赖外部账户/数据可见性，在公开 GitHub 资料中可能为空或损坏。
> clone 数和 release 下载数需要 GitHub Traffic API 认证，无法直接嵌入公开 README。
