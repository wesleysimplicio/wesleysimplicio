...
[English](README.md) · [Português](README.pt-BR.md) · [Español](README.es.md) · [日本語](README.ja.md) · [한국어](README.ko.md) · [简体中文](README.zh-CN.md) · [Italiano](README.it.md) · [Français](README.fr.md) · [Русский](README.ru.md) · **Polski** · [हिन्दी](README.hi.md) · [العربية](README.ar.md) · [עברית](README.he.md) · [Bahasa Melayu](README.ms.md) · [Bahasa Indonesia](README.id.md)
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/ds4-simplicio-apple-v6/main/assets/us4-v6-apple-edition-promo.png" alt="DS4 Simplicio Apple V6 promotional banner" width="100%" />
  ...
  <p>On-device Universal State Runtime dla LLM na Apple Silicon z MLX, Metal, architekturą ukierunkowaną na ANE, C++17/20 i ścieżkami inferencji local-first.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-dev-cli/master/output/imagegen/simplicio-cli-readme-hero-web.png" alt="simplicio-dev-cli verified execution pipeline hero" width="100%" />
  ...
  <p>CLI wykonawcze zamieniające jednowierszowe zadania software w zmapowane zmiany, diffy, testy, dowody walidacji i przeglądalne pętle implementacji.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-mapper/main/assets/llm-project-mapper-hero.png" alt="simplicio-mapper hero" width="100%" />
  ...
  <p>Stack-neutral mapper projektu dla agentic development: artefakty `.simplicio`, kontekst projektu, struktura startowa i powtarzalne workflow AI coding.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-prompt/main/docs/assets/yool-v2-safe-speed-infographic-pt.png" alt="simplicio-prompt yool tuple HAMT infographic" width="100%" />
  ...
  <p>Wzorzec capability-addressing dla systemów agentowych: yool, tuple-space, katalogi HAMT, guardrails, receipts i referencyjne kernele.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/hermes-turbo-agent/codex/hermes-agent-100x-fast/docs/assets/hermes-turbo-brand/hermes-turbo-agent-vs-openclaw-banner.png" alt="Hermes turbo agent benchmark banner" width="100%" />
  ...
  <p>Gałąź performance Hermes Agent z runtime benchmarks, porównaniami wizualnymi, ścieżkami low-latency i bezpiecznym badaniem hot paths.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-sprint/main/docs/assets/sendsprint-hero.png" alt="simplicio-sprint hero" width="100%" />
  ...
  <p>Multi-agent workflow sprint delivery: czyta systemy sprint, mapuje architekturę repo, rozdziela implementację i weryfikuje kontekst dostawy.</p>
</td>
  </tr>
</table>
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/PiAPI-Skills/main/presentation/remotion-tutorial/media/en/preview.gif" alt="PiAPI Skills tutorial preview" width="100%" />
  ...
  <p>Bundle skilli dla Claude, Codex, Hermes, OpenClaw, Cursor, Windsurf i generic agents, obejmujący media generation i workflow LLM.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/WaveSpeedAI-Skills/main/docs/media/tutorial-poster-en.png" alt="WaveSpeedAI Skills tutorial poster" width="100%" />
  ...
  <p>Jeden installer i CLI dla modeli WaveSpeedAI w hosts zgodnych z agentskills.io i środowiskach multi-agent.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-marketing-engine/main/assets/readme/marketing-engine-hero.svg" alt="simplicio-marketing-engine hero" width="100%" />
  ...
  <p>Provider-agnostic AI marketing CLI: brief, script, creative, caption, compliance, publish, metrics, ads oraz routing modeli przez env.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/x-virality-skills/main/skills/x-virality/assets/x-virality-hero.png" alt="x-virality-skills hero" width="100%" />
  ...
  <p>Standalone skill repo do optymalizacji postów X z source-grounded referencjami algorytmu For You, narzędziami i testami.</p>
</td>
  </tr>
</table>
...
<td width="50%" valign="top">
  ...
  <p>Edycja Windows lokalnego runtime inferencji dla NVIDIA, AMD, Intel, NPU, CUDA, DirectML, Vulkan, AVX i Windows ML.</p>
</td>
<td width="50%" valign="top">
  <h3><a href="https://github.com/wesleysimplicio/x-bookmarks-panel">x-bookmarks-panel</a></h3>
  <p>Local-first panel Flask zamieniający bookmarks z x.com w actionable queue do AI-assisted triage i execution.</p>
  <h3><a href="https://github.com/wesleysimplicio/sistema-sindico">sistema-sindico</a></h3>
  <p>System zarządzania wspólnotą w PHP/MySQL z podstawami API dla mobile workflows.</p>
  <h3><a href="https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli">brazil-bank CLI suite</a></h3>
  <p>Eksperymenty CLI Open Finance i banków brazylijskich: BB, BTG, Inter, Matera, PagBank, PicPay i Open Finance BR.</p>
  <h3><a href="https://github.com/wesleysimplicio?tab=repositories">więcej repozytoriów</a></h3>
  <p>Dodatkowe prace w C#, PHP, TypeScript, Rust, Python, C++, narzędziach lokalnych, prototypach SaaS i eksperymentach infrastruktury AI.</p>
</td>
  </tr>
</table>
...
## `ostatnie_publiczne_repozytoria`

| Projekt | Stack | Fokus |
|---|---|---|
| [simplicio-dev-cli](https://github.com/wesleysimplicio/simplicio-dev-cli) | Python | Zweryfikowana pętla implementacji dla agentic software tasks |
| [simplicio-sprint](https://github.com/wesleysimplicio/simplicio-sprint) | Python | Multi-agent sprint delivery i weryfikacja kontekstu repo |
| [ds4-simplicio-apple-v6](https://github.com/wesleysimplicio/ds4-simplicio-apple-v6) | C++ | Lokalny runtime LLM dla Apple Silicon |
| [ds4-simplicio-windows-v6](https://github.com/wesleysimplicio/ds4-simplicio-windows-v6) | C++ | Lokalny runtime LLM dla Windows |
| [simplicio-marketing-engine](https://github.com/wesleysimplicio/simplicio-marketing-engine) | TypeScript | Provider-agnostic automatyzacja marketingu AI |
| [sistema-sindico](https://github.com/wesleysimplicio/sistema-sindico) | PHP | System wspólnoty i fundament API |
| [brazil-bank-open-finance-br-cli](https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli) | Python | Badania Open Finance BR CLI |
| [brazil-bank-bb-cli](https://github.com/wesleysimplicio/brazil-bank-bb-cli), [btg](https://github.com/wesleysimplicio/brazil-bank-btg-cli), [inter](https://github.com/wesleysimplicio/brazil-bank-inter-cli), [matera](https://github.com/wesleysimplicio/brazil-bank-matera-cli), [pagbank](https://github.com/wesleysimplicio/brazil-bank-pagbank-cli), [picpay](https://github.com/wesleysimplicio/brazil-bank-picpay-cli) | JavaScript | Eksperymenty CLI banków brazylijskich |
| [phoenix-x-algorithm](https://github.com/wesleysimplicio/phoenix-x-algorithm) | Python | Badanie algorytmu X i lokalne eksperymenty |
| [bookmarks-oss](https://github.com/wesleysimplicio/bookmarks-oss) | OSS workflow | Bookmark-driven knowledge i triage experiments |
...
- Interesuje mnie AI działająca w realnych środowiskach operacyjnych, nie tylko w demo.
- Buduję systemy, które zachowują kontekst, mapują repozytoria, koordynują agentów i automatyzują delivery.
- Szukam uznania poprzez wpływ: otwartą pracę, poważną inżynierię i możliwości w firmach zdolnych to skalować.
- Kierunek jest prosty: używać AI, aby tworzyć większą dźwignię dla ludzi, zespołów i przyszłości software.

---

## `podziekowanie_mentorowi`

Specjalne podziękowania dla mojego mentora [Jesse Daniel Brown, PhD](https://github.com/JesseBrown1980), pochodzącego z Kalifornii w USA i autora ponad 100 artykułów naukowych. Jego humanitarna i edukacyjna perspektywa programowania, AI i nauki wzmocniła moją misję: budować praktyczne systemy AI zwiększające ludzkie możliwości.
...
### historia gwiazdek głównych projektów
...
### podsumowanie języków i repozytoriów
...
> Ranking zaktualizowany z publicznego GitHub API 2026-06-01, z wyłączeniem forków i repozytorium profilu. Badge gwiazdek i forków aktualizują się automatycznie z GitHub.
> WakaTime pozostaje usunięty, ponieważ zależy od zewnętrznego konta/widoczności danych i może renderować się pusto lub błędnie w publicznym profilu GitHub.
> Liczby clone i release download wymagają uwierzytelnienia GitHub Traffic API i nie mogą być bezpośrednio osadzone w publicznym README.
...
### `zamieniam pomysły AI w systemy, które wykonują`
