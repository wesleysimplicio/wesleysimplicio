...
```txt
AI 네이티브 소프트웨어 엔지니어 | 에이전트와 개발하고 배포하기 전에 모든 변경을 검토합니다
```
...
[English](README.md) · [Português](README.pt-BR.md) · [Español](README.es.md) · [日本語](README.ja.md) · **한국어** · [简体中文](README.zh-CN.md) · [Italiano](README.it.md) · [Français](README.fr.md) · [Русский](README.ru.md) · [Polski](README.pl.md) · [हिन्दी](README.hi.md) · [العربية](README.ar.md) · [עברית](README.he.md) · [Bahasa Melayu](README.ms.md) · [Bahasa Indonesia](README.id.md)
...
### 실제 프로젝트에서 AI를 활용하는 방식

보통 여러 변경을 동시에 진행합니다. AI가 코드 작성을 돕지만, 각 작업은 테스트와 리뷰, PR, `main` 병합까지 직접 확인합니다.

AI는 빠르게 변하기 때문에 일하는 방식도 계속 조정합니다. 매일 실제 코드에서 새로운 방법을 시험하고, 다음 변경을 더 명확하고 안전하고 빠르게 만드는 방법만 남깁니다.

---

## `미션`

실제 프로젝트에서 사용하는 AI 도구를 만듭니다. 저장소를 이해하고, 변경하고, 테스트하고, 리뷰하고, 프로덕션에 배포하는 전 과정에 도움이 되는지를 중요하게 봅니다.
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/ds4-simplicio-apple-v6/main/assets/us4-v6-apple-edition-promo.png" alt="DS4 Simplicio Apple V6 promotional banner" width="100%" />
  ...
  <p>Apple Silicon에서 LLM을 실행하기 위한 온디바이스 Universal State Runtime입니다. MLX, Metal, ANE 지향 아키텍처, C++17/20, 로컬 우선 추론 경로를 사용합니다.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-dev-cli/master/output/imagegen/simplicio-cli-readme-hero-web.png" alt="simplicio-dev-cli verified execution pipeline hero" width="100%" />
  ...
  <p>한 줄의 소프트웨어 작업을 매핑된 변경, diff, 테스트, 검증 증거, 리뷰 가능한 구현 루프로 바꾸는 실행 CLI입니다.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-mapper/main/assets/llm-project-mapper-hero.png" alt="simplicio-mapper hero" width="100%" />
  ...
  <p>에이전트 개발을 위한 스택 중립 프로젝트 매퍼입니다. `.simplicio` 산출물, 프로젝트 컨텍스트, 스타터 구조, 반복 가능한 AI 코딩 워크플로를 제공합니다.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-prompt/main/docs/assets/yool-v2-safe-speed-infographic-pt.png" alt="simplicio-prompt yool tuple HAMT infographic" width="100%" />
  ...
  <p>에이전트 시스템을 위한 capability-addressing 패턴입니다. yool, tuple-space, HAMT 카탈로그, guardrail, receipt, 참조 kernel을 포함합니다.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/hermes-turbo-agent/codex/hermes-agent-100x-fast/docs/assets/hermes-turbo-brand/hermes-turbo-agent-vs-openclaw-banner.png" alt="Hermes turbo agent benchmark banner" width="100%" />
  ...
  <p>Hermes Agent 성능 브랜치로 런타임 벤치마크, 시각 비교, 저지연 경로, 안전한 hot-path 최적화 연구를 포함합니다.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-sprint/main/docs/assets/sendsprint-hero.png" alt="simplicio-sprint hero" width="100%" />
  ...
  <p>스프린트 시스템을 읽고, 저장소 아키텍처를 매핑하고, 구현을 배분하며, 전달 컨텍스트를 검증하는 멀티 에이전트 플로입니다.</p>
</td>
  </tr>
</table>
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/PiAPI-Skills/main/presentation/remotion-tutorial/media/en/preview.gif" alt="PiAPI Skills tutorial preview" width="100%" />
  ...
  <p>Claude, Codex, Hermes, OpenClaw, Cursor, Windsurf 및 일반 에이전트를 위한 미디어 생성과 LLM 워크플로 스킬 번들입니다.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/WaveSpeedAI-Skills/main/docs/media/tutorial-poster-en.png" alt="WaveSpeedAI Skills tutorial poster" width="100%" />
  ...
  <p>agentskills.io 호환 호스트와 멀티 에이전트 환경을 위한 WaveSpeedAI 모델 설치 프로그램 및 CLI입니다.</p>
</td>
  </tr>
  <tr>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/simplicio-marketing-engine/main/assets/readme/marketing-engine-hero.svg" alt="simplicio-marketing-engine hero" width="100%" />
  ...
  <p>공급자 독립형 AI 마케팅 CLI입니다. brief, script, creative, caption, compliance, publish, metrics, ads와 환경 기반 모델 라우팅을 다룹니다.</p>
</td>
<td width="50%" valign="top">
...
<img src="https://raw.githubusercontent.com/wesleysimplicio/x-virality-skills/main/skills/x-virality/assets/x-virality-hero.png" alt="x-virality-skills hero" width="100%" />
  ...
  <p>출처 기반 For You 알고리즘 참고자료, 도구, 테스트로 X 게시물을 최적화하는 독립 스킬 저장소입니다.</p>
</td>
  </tr>
</table>
...
<td width="50%" valign="top">
  ...
  <p>NVIDIA, AMD, Intel, NPU, CUDA, DirectML, Vulkan, AVX, Windows ML을 대상으로 하는 로컬 추론 런타임의 Windows 에디션입니다.</p>
</td>
<td width="50%" valign="top">
  <h3><a href="https://github.com/wesleysimplicio/x-bookmarks-panel">x-bookmarks-panel</a></h3>
  <p>x.com 북마크를 AI 보조 분류와 실행 큐로 바꾸는 로컬 우선 Flask 패널입니다.</p>
  <h3><a href="https://github.com/wesleysimplicio/sistema-sindico">sistema-sindico</a></h3>
  <p>모바일 앱 워크플로를 위한 API 기반을 갖춘 PHP/MySQL 공동주택 관리 시스템입니다.</p>
  <h3><a href="https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli">brazil-bank CLI suite</a></h3>
  <p>BB, BTG, Inter, Matera, PagBank, PicPay, Open Finance BR을 포함한 브라질 은행 CLI 실험입니다.</p>
  <h3><a href="https://github.com/wesleysimplicio?tab=repositories">더 많은 저장소</a></h3>
  <p>C#, PHP, TypeScript, Rust, Python, C++, 로컬 도구, SaaS 프로토타입, AI 인프라 실험 전반의 추가 작업입니다.</p>
</td>
  </tr>
</table>
...
| 프로젝트 | 스택 | 초점 |
|---|---|---|
| [simplicio-dev-cli](https://github.com/wesleysimplicio/simplicio-dev-cli) | Python | 에이전트형 소프트웨어 작업을 위한 검증된 구현 루프 |
| [simplicio-sprint](https://github.com/wesleysimplicio/simplicio-sprint) | Python | 멀티 에이전트 스프린트 전달과 저장소 컨텍스트 검증 |
| [ds4-simplicio-apple-v6](https://github.com/wesleysimplicio/ds4-simplicio-apple-v6) | C++ | Apple Silicon 로컬 LLM 런타임 |
| [ds4-simplicio-windows-v6](https://github.com/wesleysimplicio/ds4-simplicio-windows-v6) | C++ | Windows 로컬 LLM 런타임 |
| [simplicio-marketing-engine](https://github.com/wesleysimplicio/simplicio-marketing-engine) | TypeScript | 공급자 독립형 AI 마케팅 자동화 |
| [sistema-sindico](https://github.com/wesleysimplicio/sistema-sindico) | PHP | 공동주택 관리 시스템과 API 기반 |
| [brazil-bank-open-finance-br-cli](https://github.com/wesleysimplicio/brazil-bank-open-finance-br-cli) | Python | Open Finance BR CLI 연구 |
| [brazil-bank-bb-cli](https://github.com/wesleysimplicio/brazil-bank-bb-cli), [btg](https://github.com/wesleysimplicio/brazil-bank-btg-cli), [inter](https://github.com/wesleysimplicio/brazil-bank-inter-cli), [matera](https://github.com/wesleysimplicio/brazil-bank-matera-cli), [pagbank](https://github.com/wesleysimplicio/brazil-bank-pagbank-cli), [picpay](https://github.com/wesleysimplicio/brazil-bank-picpay-cli) | JavaScript | 브라질 은행 CLI 실험 |
| [phoenix-x-algorithm](https://github.com/wesleysimplicio/phoenix-x-algorithm) | Python | X 알고리즘 연구와 로컬 실험 |
| [bookmarks-oss](https://github.com/wesleysimplicio/bookmarks-oss) | OSS workflow | 북마크 기반 지식 및 분류 실험 |
...
- 저는 데모뿐 아니라 실제 운영 환경에서 작동하는 AI를 중요하게 생각합니다.
- 컨텍스트를 보존하고, 저장소를 매핑하고, 에이전트를 조정하고, 전달을 자동화하는 시스템을 만듭니다.
- 오픈 작업, 진지한 엔지니어링, 이를 확장할 수 있는 회사와의 기회를 통해 영향력으로 인정받고자 합니다.
- 방향은 단순합니다. AI로 사람, 팀, 소프트웨어의 미래에 더 큰 레버리지를 만드는 것입니다.

---

## `멘토_감사`

저의 멘토 [Jesse Daniel Brown, PhD](https://github.com/JesseBrown1980)께 특별히 감사드립니다. 그는 미국 캘리포니아 출신이며 100편 이상의 과학 논문 저자입니다. 프로그래밍, AI, 과학에 대한 그의 인도주의적이고 교육적인 관점은 인간 능력을 확장하는 실용적 AI 시스템을 만들겠다는 제 미션을 강화해 주었습니다.
...
> 순위는 2026-06-01 GitHub 공개 API 기준이며, fork와 프로필 저장소는 제외했습니다. 스타와 포크 배지는 GitHub에서 자동 업데이트됩니다.
> WakaTime은 외부 계정/데이터 공개 상태에 의존해 공개 GitHub 프로필에서 비어 있거나 깨질 수 있으므로 계속 제거되어 있습니다.
> clone 수와 release download 수는 GitHub Traffic API 인증이 필요하여 공개 README에 직접 삽입할 수 없습니다.
